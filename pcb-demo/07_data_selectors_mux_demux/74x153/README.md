...
| -------------------- | ------------------ |
| **汎用型番**         | `74x153`  |
| **機能 (EN)**        | Dual 4-input multiplexer    |
| **機能 (JP)**        | 2回路4入力マルチプレクサ |
| **カテゴリ**         | `07_data_selectors_mux_demux`     |
| **入手済み (CMOS)**  | 74HC153AP     |
| **入手済み (TTL)**   | 74LS153N, 74F153, HD74LS153P      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x153.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x153.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x153.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x153.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/07_data_selectors_mux_demux/74x153/`](../../../usage/07_data_selectors_mux_demux/74x153/)
...
- [ ] `usage/07_data_selectors_mux_demux/74x153/` のファクトチェックが完了している
