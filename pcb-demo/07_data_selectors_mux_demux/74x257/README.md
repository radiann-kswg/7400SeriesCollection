...
| -------------------- | ------------------ |
| **汎用型番**         | `74x257`  |
| **機能 (EN)**        | Quad 2-to-1 multiplexer with 3-state outputs    |
| **機能 (JP)**        | 4回路2入力マルチプレクサ（3状態出力） |
| **カテゴリ**         | `07_data_selectors_mux_demux`     |
| **入手済み (CMOS)**  | SN74HC257N     |
| **入手済み (TTL)**   | 74LS257AN, 74F257AN, SN74ALS257AN, SN74F257N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x257.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x257.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x257.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x257.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/07_data_selectors_mux_demux/74x257/`](../../../usage/07_data_selectors_mux_demux/74x257/)
...
- [ ] `usage/07_data_selectors_mux_demux/74x257/` のファクトチェックが完了している
