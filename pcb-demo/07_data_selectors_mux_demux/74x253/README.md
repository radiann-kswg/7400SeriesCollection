...
| -------------------- | ------------------ |
| **汎用型番**         | `74x253`  |
| **機能 (EN)**        | Dual 4-to-1 multiplexer with 3-state outputs    |
| **機能 (JP)**        | 2回路4入力マルチプレクサ（3状態出力） |
| **カテゴリ**         | `07_data_selectors_mux_demux`     |
| **入手済み (CMOS)**  | CD74HC253E     |
| **入手済み (TTL)**   | DM74ALS253N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x253.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x253.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x253.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x253.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/07_data_selectors_mux_demux/74x253/`](../../../usage/07_data_selectors_mux_demux/74x253/)
...
- [ ] `usage/07_data_selectors_mux_demux/74x253/` のファクトチェックが完了している
