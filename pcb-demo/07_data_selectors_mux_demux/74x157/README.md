...
| -------------------- | ------------------ |
| **汎用型番**         | `74x157`  |
| **機能 (EN)**        | Quad 2-to-1 multiplexer    |
| **機能 (JP)**        | 4回路2入力マルチプレクサ |
| **カテゴリ**         | `07_data_selectors_mux_demux`     |
| **入手済み (CMOS)**  | SN74HC157N     |
| **入手済み (TTL)**   | 74S157, 74F157A, DM74S157N, MC74F157AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x157.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x157.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x157.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x157.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/07_data_selectors_mux_demux/74x157/`](../../../usage/07_data_selectors_mux_demux/74x157/)
...
- [ ] `usage/07_data_selectors_mux_demux/74x157/` のファクトチェックが完了している
