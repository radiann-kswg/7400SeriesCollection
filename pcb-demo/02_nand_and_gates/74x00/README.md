...
| **入手済み (CMOS)**  | 74HC00N, 74HC00AP, SN74HC00N, HD74HC00F, TC74HC00AF, U74HC00L     |
| **入手済み (TTL)**   | SN74S00N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x00.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x00.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x00.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x00.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x00/`](../../../usage/02_nand_and_gates/74x00/)
...
- [ ] `usage/02_nand_and_gates/74x00/` のファクトチェックが完了している
