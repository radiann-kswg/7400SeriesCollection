...
| -------------------- | ------------------ |
| **汎用型番**         | `74x50`  |
| **機能 (EN)**        | Dual 2-2-input AND-OR-Invert gate, one gate expandable    |
| **機能 (JP)**        | 2回路2入力AND-OR-インバートゲート（1つのゲートは拡張可能） |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | K1LR551/К1ЛР551    |

## KiCAD プロジェクト構成

| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x50.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x50.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x50.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x50.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x50/`](../../../usage/02_nand_and_gates/74x50/)
...
- [ ] `usage/02_nand_and_gates/74x50/` のファクトチェックが完了している
