...
| -------------------- | ------------------ |
| **汎用型番**         | `74x20`  |
| **機能 (EN)**        | Dual 4-input NAND gate    |
| **機能 (JP)**        | 2回路4入力NANDゲート |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | 74HC20AP     |
| **入手済み (TTL)**   | 74F20N, SN74LS20N, DM74S20N, DM74LS20N, MC74F20N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x20.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x20.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x20.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x20.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x20/`](../../../usage/02_nand_and_gates/74x20/)
...
- [ ] `usage/02_nand_and_gates/74x20/` のファクトチェックが完了している
