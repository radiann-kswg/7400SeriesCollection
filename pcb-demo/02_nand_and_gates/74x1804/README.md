...
| -------------------- | ------------------ |
| **汎用型番**         | `74x1804`  |
| **機能 (EN)**        | hex 2-input NAND    |
| **機能 (JP)**        | 6回路2入力NANDゲート |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | DM74AS1804N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x1804.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x1804.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x1804.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x1804.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x1804/`](../../../usage/02_nand_and_gates/74x1804/)
...
- [ ] `usage/02_nand_and_gates/74x1804/` のファクトチェックが完了している
