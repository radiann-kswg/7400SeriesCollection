...
| -------------------- | ------------------ |
| **汎用型番**         | `74x21`  |
| **機能 (EN)**        | Dual 4-input AND gate    |
| **機能 (JP)**        | 2回路4入力ANDゲート |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | 74HC21AP, SN74HC21N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x21.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x21.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x21.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x21.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x21/`](../../../usage/02_nand_and_gates/74x21/)
...
- [ ] `usage/02_nand_and_gates/74x21/` のファクトチェックが完了している
