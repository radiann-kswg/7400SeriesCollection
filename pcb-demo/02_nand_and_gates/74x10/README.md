...
| -------------------- | ------------------ |
| **汎用型番**         | `74x10`  |
| **機能 (EN)**        | Triple 3-input NAND gate    |
| **機能 (JP)**        | 3回路3入力NANDゲート |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x10.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x10.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x10.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x10.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x10/`](../../../usage/02_nand_and_gates/74x10/)
...
- [ ] `usage/02_nand_and_gates/74x10/` のファクトチェックが完了している
