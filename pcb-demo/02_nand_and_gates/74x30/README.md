...
| -------------------- | ------------------ |
| **汎用型番**         | `74x30`  |
| **機能 (EN)**        | 8-input NAND gate    |
| **機能 (JP)**        | 8入力NANDゲート |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | SN74HC30N     |
| **入手済み (TTL)**   | 74F30PC, SN74H30N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x30.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x30.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x30.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x30.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x30/`](../../../usage/02_nand_and_gates/74x30/)
...
- [ ] `usage/02_nand_and_gates/74x30/` のファクトチェックが完了している
