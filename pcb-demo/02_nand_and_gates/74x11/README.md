...
| -------------------- | ------------------ |
| **汎用型番**         | `74x11`  |
| **機能 (EN)**        | Triple 3-input AND gate    |
| **機能 (JP)**        | 3回路3入力ANDゲート |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | SN74HC11N     |
| **入手済み (TTL)**   | HD74LS11P, DM74AS11N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x11.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x11.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x11.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x11.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x11/`](../../../usage/02_nand_and_gates/74x11/)
...
- [ ] `usage/02_nand_and_gates/74x11/` のファクトチェックが完了している
