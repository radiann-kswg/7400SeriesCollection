...
| -------------------- | ------------------ |
| **汎用型番**         | `74x64`  |
| **機能 (EN)**        | 4-3-2-2-input AND-OR-Invert gate    |
| **機能 (JP)**        | 4-3-2-2入力AND-OR-インバートゲート |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | 74F64N, MC74F64N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x64.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x64.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x64.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x64.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x64/`](../../../usage/02_nand_and_gates/74x64/)
...
- [ ] `usage/02_nand_and_gates/74x64/` のファクトチェックが完了している
