...
| -------------------- | ------------------ |
| **汎用型番**         | `74x09`  |
| **機能 (EN)**        | Quad 2-input AND gate, open-collector outputs    |
| **機能 (JP)**        | 4回路2入力ANDゲート（オープンコレクタ出力） |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x09.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x09.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x09.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x09.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x09/`](../../../usage/02_nand_and_gates/74x09/)
...
- [ ] `usage/02_nand_and_gates/74x09/` のファクトチェックが完了している
