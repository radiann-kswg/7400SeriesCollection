...
| -------------------- | ------------------ |
| **汎用型番**         | `74x03`  |
| **機能 (EN)**        | Quad 2-input NAND gate with open-collector outputs    |
| **機能 (JP)**        | 4回路2入力NANDゲート（オープンコレクタ出力） |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | MC74HC03AN     |
| **入手済み (TTL)**   | SN7403, HD74LS03P      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x03.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x03.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x03.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x03.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x03/`](../../../usage/02_nand_and_gates/74x03/)
...
- [ ] `usage/02_nand_and_gates/74x03/` のファクトチェックが完了している
