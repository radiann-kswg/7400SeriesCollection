...
| -------------------- | ------------------ |
| **汎用型番**         | `74x08`  |
| **機能 (EN)**        | Quad 2-input AND gate    |
| **機能 (JP)**        | 4回路2入力ANDゲート |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | 74HC08AP, SN74HC08N     |
| **入手済み (TTL)**   | 74S08DC, SN74AS08N, SN74ALS08N, MC74F08N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x08.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x08.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x08.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x08.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x08/`](../../../usage/02_nand_and_gates/74x08/)
...
- [ ] `usage/02_nand_and_gates/74x08/` のファクトチェックが完了している
