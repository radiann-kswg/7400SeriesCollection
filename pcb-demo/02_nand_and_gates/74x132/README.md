...
| -------------------- | ------------------ |
| **汎用型番**         | `74x132`  |
| **機能 (EN)**        | Quad 2-input NAND gate with Schmitt-trigger inputs    |
| **機能 (JP)**        | 4回路2入力NANDゲート（シュミットトリガ入力） |
| **カテゴリ**         | `02_nand_and_gates`     |
| **入手済み (CMOS)**  | SN74HC132N     |
| **入手済み (TTL)**   | 74S132      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x132.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x132.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x132.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x132.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/02_nand_and_gates/74x132/`](../../../usage/02_nand_and_gates/74x132/)
...
- [ ] `usage/02_nand_and_gates/74x132/` のファクトチェックが完了している
