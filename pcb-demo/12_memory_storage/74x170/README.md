...
| -------------------- | ------------------ |
| **汎用型番**         | `74x170`  |
| **機能 (EN)**        | 16-bit register file (4x4)    |
| **機能 (JP)**        | 16ビットレジスタファイル（4×4） |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x170.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x170.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x170.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x170.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/12_memory_storage/74x170/`](../../../usage/12_memory_storage/74x170/)
...
- [ ] `usage/12_memory_storage/74x170/` のファクトチェックが完了している
