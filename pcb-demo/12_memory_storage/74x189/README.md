...
| -------------------- | ------------------ |
| **汎用型番**         | `74x189`  |
| **機能 (EN)**        | 64-bit random access memory (RAM)    |
| **機能 (JP)**        | 64ビットランダムアクセスメモリ（RAM） |
| **カテゴリ**         | `12_memory_storage`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74LS189AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x189.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x189.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x189.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x189.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/12_memory_storage/74x189/`](../../../usage/12_memory_storage/74x189/)
...
- [ ] `usage/12_memory_storage/74x189/` のファクトチェックが完了している
