...
| -------------------- | ------------------ |
| **汎用型番**         | `74x670`  |
| **機能 (EN)**        | 4 x 4 register file    |
| **機能 (JP)**        | 4×4レジスタファイル |
| **カテゴリ**         | `12_memory_storage`     |
| **入手済み (CMOS)**  | CD74HC670E     |
| **入手済み (TTL)**   | HD74LS670N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x670.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x670.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x670.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x670.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/12_memory_storage/74x670/`](../../../usage/12_memory_storage/74x670/)
...
- [ ] `usage/12_memory_storage/74x670/` のファクトチェックが完了している
