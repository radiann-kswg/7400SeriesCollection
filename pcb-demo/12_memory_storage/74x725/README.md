...
| -------------------- | ------------------ |
| **汎用型番**         | `74x725`  |
| **機能 (EN)**        | 4608-bit FIFO memory (512×9)    |
| **機能 (JP)**        | 4608ビットFIFOメモリ（512×9） |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x725.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x725.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x725.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x725.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/12_memory_storage/74x725/`](../../../usage/12_memory_storage/74x725/)
...
- [ ] `usage/12_memory_storage/74x725/` のファクトチェックが完了している
