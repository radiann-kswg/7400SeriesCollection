...
| -------------------- | ------------------ |
| **汎用型番**         | `74x1034`  |
| **機能 (EN)**        | (No description)    |
| **機能 (JP)**        | (説明なし) |
| **カテゴリ**         | `99_other`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74AS1034AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x1034.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x1034.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x1034.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x1034.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/99_other/74x1034/`](../../../usage/99_other/74x1034/)
...
- [ ] `usage/99_other/74x1034/` のファクトチェックが完了している
