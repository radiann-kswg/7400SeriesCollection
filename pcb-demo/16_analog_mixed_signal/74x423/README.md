...
| -------------------- | ------------------ |
| **汎用型番**         | `74x423`  |
| **機能 (EN)**        | Dual retriggerable monostable multivibrator    |
| **機能 (JP)**        | 2回路リトリガ可能単安定マルチバイブレータ |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x423.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x423.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x423.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x423.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/16_analog_mixed_signal/74x423/`](../../../usage/16_analog_mixed_signal/74x423/)
...
- [ ] `usage/16_analog_mixed_signal/74x423/` のファクトチェックが完了している
