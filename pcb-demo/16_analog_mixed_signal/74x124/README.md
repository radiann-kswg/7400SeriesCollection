...
| -------------------- | ------------------ |
| **汎用型番**         | `74x124`  |
| **機能 (EN)**        | Dual voltage-controlled oscillator    |
| **機能 (JP)**        | 2回路電圧制御発振器 |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x124.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x124.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x124.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x124.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/16_analog_mixed_signal/74x124/`](../../../usage/16_analog_mixed_signal/74x124/)
...
- [ ] `usage/16_analog_mixed_signal/74x124/` のファクトチェックが完了している
