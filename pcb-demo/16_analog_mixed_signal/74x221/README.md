...
| -------------------- | ------------------ |
| **汎用型番**         | `74x221`  |
| **機能 (EN)**        | Dual monostable multivibrator    |
| **機能 (JP)**        | 2回路単安定マルチバイブレータ |
| **カテゴリ**         | `16_analog_mixed_signal`     |
| **入手済み (CMOS)**  | CD74HC221E     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x221.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x221.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x221.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x221.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/16_analog_mixed_signal/74x221/`](../../../usage/16_analog_mixed_signal/74x221/)
...
- [ ] `usage/16_analog_mixed_signal/74x221/` のファクトチェックが完了している
