...
| -------------------- | ------------------ |
| **汎用型番**         | `74x521`  |
| **機能 (EN)**        | 8-bit comparator, inverting output    |
| **機能 (JP)**        | 8ビットコンパレータ（反転出力） |
| **カテゴリ**         | `16_analog_mixed_signal`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74ALS521N, MC74F521N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x521.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x521.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x521.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x521.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/16_analog_mixed_signal/74x521/`](../../../usage/16_analog_mixed_signal/74x521/)
...
- [ ] `usage/16_analog_mixed_signal/74x521/` のファクトチェックが完了している
