...
| -------------------- | ------------------ |
| **汎用型番**         | `74x682`  |
| **機能 (EN)**        | 8-bit magnitude comparator    |
| **機能 (JP)**        | 8ビットマグニチュードコンパレータ |
| **カテゴリ**         | `16_analog_mixed_signal`     |
| **入手済み (CMOS)**  | SN74HC682N     |
| **入手済み (TTL)**   | SN74LS682N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x682.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x682.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x682.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x682.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/16_analog_mixed_signal/74x682/`](../../../usage/16_analog_mixed_signal/74x682/)
...
- [ ] `usage/16_analog_mixed_signal/74x682/` のファクトチェックが完了している
