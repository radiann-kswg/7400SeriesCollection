...
| -------------------- | ------------------ |
| **汎用型番**         | `74x90`  |
| **機能 (EN)**        | Decade counter (4-bit, divide-by-10 and divide-by-2 sections)    |
| **機能 (JP)**        | 10進カウンタ（4ビット、10分周・2分周セクション） |
| **カテゴリ**         | `08_counters`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74LS90N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x90.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x90.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x90.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x90.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/08_counters/74x90/`](../../../usage/08_counters/74x90/)
...
- [ ] `usage/08_counters/74x90/` のファクトチェックが完了している
