...
| -------------------- | ------------------ |
| **汎用型番**         | `74x293`  |
| **機能 (EN)**        | 4-bit binary counter, up/down, separate clocks    |
| **機能 (JP)**        | 4ビットバイナリカウンタ（アップ/ダウン、独立クロック） |
| **カテゴリ**         | `08_counters`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74LS293N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x293.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x293.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x293.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x293.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/08_counters/74x293/`](../../../usage/08_counters/74x293/)
...
- [ ] `usage/08_counters/74x293/` のファクトチェックが完了している
