...
| -------------------- | ------------------ |
| **汎用型番**         | `74x393`  |
| **機能 (EN)**        | Dual 4-bit binary counter    |
| **機能 (JP)**        | 2回路4ビットバイナリカウンタ |
| **カテゴリ**         | `08_counters`     |
| **入手済み (CMOS)**  | SN74HC393N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x393.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x393.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x393.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x393.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/08_counters/74x393/`](../../../usage/08_counters/74x393/)
...
- [ ] `usage/08_counters/74x393/` のファクトチェックが完了している
