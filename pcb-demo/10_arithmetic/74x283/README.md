...
| -------------------- | ------------------ |
| **汎用型番**         | `74x283`  |
| **機能 (EN)**        | 4-bit binary full adder    |
| **機能 (JP)**        | 4ビットバイナリ全加算器 |
| **カテゴリ**         | `10_arithmetic`     |
| **入手済み (CMOS)**  | CD74HC283E     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x283.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x283.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x283.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x283.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/10_arithmetic/74x283/`](../../../usage/10_arithmetic/74x283/)
...
- [ ] `usage/10_arithmetic/74x283/` のファクトチェックが完了している
