...
| -------------------- | ------------------ |
| **汎用型番**         | `74x181`  |
| **機能 (EN)**        | 4-bit arithmetic logic unit (ALU)    |
| **機能 (JP)**        | 4ビット算術論理演算装置（ALU） |
| **カテゴリ**         | `10_arithmetic`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74S181NC      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x181.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x181.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x181.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x181.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/10_arithmetic/74x181/`](../../../usage/10_arithmetic/74x181/)
...
- [ ] `usage/10_arithmetic/74x181/` のファクトチェックが完了している
