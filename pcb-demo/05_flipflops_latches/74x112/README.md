...
| -------------------- | ------------------ |
| **汎用型番**         | `74x112`  |
| **機能 (EN)**        | Dual JK flip-flop, negative-edge-triggered, preset and clear    |
| **機能 (JP)**        | 2回路JKフリップフロップ（負論理エッジトリガ、プリセット・クリア付き） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | SN74HC112N     |
| **入手済み (TTL)**   | 74LS112N, SN74LS112AN, HD74LS112P      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x112.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x112.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x112.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x112.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x112/`](../../../usage/05_flipflops_latches/74x112/)
...
- [ ] `usage/05_flipflops_latches/74x112/` のファクトチェックが完了している
