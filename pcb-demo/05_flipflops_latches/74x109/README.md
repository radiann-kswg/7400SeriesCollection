...
| -------------------- | ------------------ |
| **汎用型番**         | `74x109`  |
| **機能 (EN)**        | Dual JK flip-flop, positive-edge-triggered, set and reset    |
| **機能 (JP)**        | 2回路JKフリップフロップ（正論理エッジトリガ、セット・リセット付き） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | SN74HC109N     |
| **入手済み (TTL)**   | SN74F109N, SN74LS109AN, MC74F109N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x109.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x109.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x109.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x109.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x109/`](../../../usage/05_flipflops_latches/74x109/)
...
- [ ] `usage/05_flipflops_latches/74x109/` のファクトチェックが完了している
