...
| -------------------- | ------------------ |
| **汎用型番**         | `74x174`  |
| **機能 (EN)**        | Hex D-type flip-flop    |
| **機能 (JP)**        | 6回路D型フリップフロップ |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | SN74HC174N     |
| **入手済み (TTL)**   | SN74ALS714N, DM74174N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x174.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x174.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x174.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x174.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x174/`](../../../usage/05_flipflops_latches/74x174/)
...
- [ ] `usage/05_flipflops_latches/74x174/` のファクトチェックが完了している
