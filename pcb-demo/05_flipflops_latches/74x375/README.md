...
| -------------------- | ------------------ |
| **汎用型番**         | `74x375`  |
| **機能 (EN)**        | Quad D-type latch    |
| **機能 (JP)**        | 4ビットD型ラッチ |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | 74LS375N, SN74LS375N, M74LS375P      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x375.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x375.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x375.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x375.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x375/`](../../../usage/05_flipflops_latches/74x375/)
...
- [ ] `usage/05_flipflops_latches/74x375/` のファクトチェックが完了している
