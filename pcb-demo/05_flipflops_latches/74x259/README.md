...
| -------------------- | ------------------ |
| **汎用型番**         | `74x259`  |
| **機能 (EN)**        | 8-bit addressable latch    |
| **機能 (JP)**        | 8ビットアドレサブルラッチ |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | SN74HC259N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x259.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x259.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x259.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x259.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x259/`](../../../usage/05_flipflops_latches/74x259/)
...
- [ ] `usage/05_flipflops_latches/74x259/` のファクトチェックが完了している
