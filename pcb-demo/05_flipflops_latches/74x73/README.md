...
| -------------------- | ------------------ |
| **汎用型番**         | `74x73`  |
| **機能 (EN)**        | Dual JK flip-flop, negative-edge-triggered, clear    |
| **機能 (JP)**        | 2回路JKフリップフロップ（負論理エッジトリガ、クリア付き） |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x73.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x73.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x73.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x73.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x73/`](../../../usage/05_flipflops_latches/74x73/)
...
- [ ] `usage/05_flipflops_latches/74x73/` のファクトチェックが完了している
