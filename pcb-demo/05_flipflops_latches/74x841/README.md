...
| -------------------- | ------------------ |
| **汎用型番**         | `74x841`  |
| **機能 (EN)**        | 10-bit D-type flip-flop    |
| **機能 (JP)**        | 10ビットD型フリップフロップ |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74ALS841NT      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x841.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x841.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x841.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x841.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x841/`](../../../usage/05_flipflops_latches/74x841/)
...
- [ ] `usage/05_flipflops_latches/74x841/` のファクトチェックが完了している
