...
| -------------------- | ------------------ |
| **汎用型番**         | `74x825`  |
| **機能 (EN)**        | 8-bit D-type flip-flops with clear and clock enable    |
| **機能 (JP)**        | 8ビット D型フリップフロップ（クリア・クロックイネーブル付） |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x825.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x825.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x825.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x825.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x825/`](../../../usage/05_flipflops_latches/74x825/)
...
- [ ] `usage/05_flipflops_latches/74x825/` のファクトチェックが完了している
