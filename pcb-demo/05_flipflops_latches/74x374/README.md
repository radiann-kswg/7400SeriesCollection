...
| -------------------- | ------------------ |
| **汎用型番**         | `74x374`  |
| **機能 (EN)**        | Octal D-type flip-flop, 3-state outputs    |
| **機能 (JP)**        | 8ビットD型フリップフロップ（3状態出力） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | SN74HC374N, SN74AHC374N, CD74HC374N     |
| **入手済み (TTL)**   | 74S374N, SN74ALS374AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x374.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x374.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x374.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x374.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x374/`](../../../usage/05_flipflops_latches/74x374/)
...
- [ ] `usage/05_flipflops_latches/74x374/` のファクトチェックが完了している
