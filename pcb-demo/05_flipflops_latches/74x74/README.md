...
| -------------------- | ------------------ |
| **汎用型番**         | `74x74`  |
| **機能 (EN)**        | Dual D flip-flop, positive-edge-triggered, set and reset    |
| **機能 (JP)**        | 2回路D型フリップフロップ（正論理エッジトリガ、セット・リセット付き） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | 74HC74AP, SN74HC74N     |
| **入手済み (TTL)**   | 74S74N, 74F74PC0R, SN74F74N, SN74ALS74AN, SN74AS74N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x74.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x74.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x74.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x74.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x74/`](../../../usage/05_flipflops_latches/74x74/)
...
- [ ] `usage/05_flipflops_latches/74x74/` のファクトチェックが完了している
