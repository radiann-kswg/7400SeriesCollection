...
| **入手済み (CMOS)**  | SN74HC574N     |
| **入手済み (TTL)**   | 74F574N, SN74ABT574AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x574.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x574.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x574.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x574.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x574/`](../../../usage/05_flipflops_latches/74x574/)
...
- [ ] `usage/05_flipflops_latches/74x574/` のファクトチェックが完了している
