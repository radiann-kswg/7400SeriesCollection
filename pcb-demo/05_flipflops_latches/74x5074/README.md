...
| -------------------- | ------------------ |
| **汎用型番**         | `74x5074`  |
| **機能 (EN)**        | dual positive-edge-triggered D-type flip-flop (metastable immune)    |
| **機能 (JP)**        | 2回路正エッジトリガDフリップフロップ（メタステーブル耐性） |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x5074.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x5074.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x5074.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x5074.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x5074/`](../../../usage/05_flipflops_latches/74x5074/)
...
- [ ] `usage/05_flipflops_latches/74x5074/` のファクトチェックが完了している
