...
| -------------------- | ------------------ |
| **汎用型番**         | `74x573`  |
| **機能 (EN)**        | Octal transparent latch, 3-state outputs    |
| **機能 (JP)**        | 8ビットトランスペアレントラッチ（3状態出力） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | SN74HC573N, CD74ACT573E     |
| **入手済み (TTL)**   | 74F573N, 74F573PC, DM74AS573N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x573.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x573.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x573.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x573.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x573/`](../../../usage/05_flipflops_latches/74x573/)
...
- [ ] `usage/05_flipflops_latches/74x573/` のファクトチェックが完了している
