...
| -------------------- | ------------------ |
| **汎用型番**         | `74x175`  |
| **機能 (EN)**        | Quad D-type flip-flop    |
| **機能 (JP)**        | 4回路D型フリップフロップ |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | 74HC175AP     |
| **入手済み (TTL)**   | 74F175, DM74175N, HD74175P, HD74LS175P, DM74AS175AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x175.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x175.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x175.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x175.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x175/`](../../../usage/05_flipflops_latches/74x175/)
...
- [ ] `usage/05_flipflops_latches/74x175/` のファクトチェックが完了している
