...
| -------------------- | ------------------ |
| **汎用型番**         | `74x563`  |
| **機能 (EN)**        | octal D-type transparent latch, inverting outputs    |
| **機能 (JP)**        | 8ビットD型トランスペアレントラッチ（反転出力） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | CD74HC563E     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x563.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x563.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x563.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x563.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x563/`](../../../usage/05_flipflops_latches/74x563/)
...
- [ ] `usage/05_flipflops_latches/74x563/` のファクトチェックが完了している
