...
| -------------------- | ------------------ |
| **汎用型番**         | `74x273`  |
| **機能 (EN)**        | Octal D-type flip-flop with clear    |
| **機能 (JP)**        | 8ビットD型フリップフロップ（クリア付き） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | 74HC273AP, SN74HC273N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x273.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x273.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x273.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x273.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x273/`](../../../usage/05_flipflops_latches/74x273/)
...
- [ ] `usage/05_flipflops_latches/74x273/` のファクトチェックが完了している
