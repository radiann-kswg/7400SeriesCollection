...
| -------------------- | ------------------ |
| **汎用型番**         | `74x533`  |
| **機能 (EN)**        | Octal D-type transparent latch, inverting, 3-state outputs    |
| **機能 (JP)**        | 8ビットD型トランスペアレントラッチ（反転、3状態出力） |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | CD74HC533E, HD74HC533P     |
| **入手済み (TTL)**   | DM74LS533N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x533.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x533.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x533.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x533.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x533/`](../../../usage/05_flipflops_latches/74x533/)
...
- [ ] `usage/05_flipflops_latches/74x533/` のファクトチェックが完了している
