...
| -------------------- | ------------------ |
| **汎用型番**         | `74x377`  |
| **機能 (EN)**        | Octal D-type flip-flop    |
| **機能 (JP)**        | 8ビットD型フリップフロップ |
| **カテゴリ**         | `05_flipflops_latches`     |
| **入手済み (CMOS)**  | SN74HC377N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x377.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x377.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x377.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x377.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x377/`](../../../usage/05_flipflops_latches/74x377/)
...
- [ ] `usage/05_flipflops_latches/74x377/` のファクトチェックが完了している
