...
| **入手済み (CMOS)**  | 74HC373AP, SN74HC373N     |
| **入手済み (TTL)**   | SN74S373N, MC74F373N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x373.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x373.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x373.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x373.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/05_flipflops_latches/74x373/`](../../../usage/05_flipflops_latches/74x373/)
...
- [ ] `usage/05_flipflops_latches/74x373/` のファクトチェックが完了している
