...
| -------------------- | ------------------ |
| **汎用型番**         | `74x194`  |
| **機能 (EN)**        | 4-bit bidirectional universal shift register    |
| **機能 (JP)**        | 4ビット双方向ユニバーサルシフトレジスタ |
| **カテゴリ**         | `09_registers`     |
| **入手済み (CMOS)**  | CD74HC194E     |
| **入手済み (TTL)**   | 74LS194AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x194.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x194.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x194.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x194.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/09_registers/74x194/`](../../../usage/09_registers/74x194/)
...
- [ ] `usage/09_registers/74x194/` のファクトチェックが完了している
