...
| -------------------- | ------------------ |
| **汎用型番**         | `74x165`  |
| **機能 (EN)**        | 8-bit parallel-in/serial-out shift register    |
| **機能 (JP)**        | 8ビットパラレル入力/シリアル出力シフトレジスタ |
| **カテゴリ**         | `09_registers`     |
| **入手済み (CMOS)**  | 74HC165AP, SN74HC165N     |
| **入手済み (TTL)**   | SN74165N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x165.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x165.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x165.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x165.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/09_registers/74x165/`](../../../usage/09_registers/74x165/)
...
- [ ] `usage/09_registers/74x165/` のファクトチェックが完了している
