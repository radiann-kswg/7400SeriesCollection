...
| **カテゴリ**         | `09_registers`     |
| **入手済み (CMOS)**  | SN74HC164N     |
| **入手済み (TTL)**   | 74F164N, SN74LS164N, HD74LS164P      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x164.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x164.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x164.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x164.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/09_registers/74x164/`](../../../usage/09_registers/74x164/)
...
- [ ] `usage/09_registers/74x164/` のファクトチェックが完了している
