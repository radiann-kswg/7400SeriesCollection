...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x126.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x126.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x126.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x126.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/01_buffers_inverters/74x126/`](../../../usage/01_buffers_inverters/74x126/)
...
- [ ] `usage/01_buffers_inverters/74x126/` のファクトチェックが完了している
