...
| **入手済み (CMOS)**  | SN74HC241N, MC74HC241N     |
| **入手済み (TTL)**   | 74LS241N, SN74LS241N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x241.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x241.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x241.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x241.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/01_buffers_inverters/74x241/`](../../../usage/01_buffers_inverters/74x241/)
...
- [ ] `usage/01_buffers_inverters/74x241/` のファクトチェックが完了している
