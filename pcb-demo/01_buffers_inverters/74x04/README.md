...
| **汎用型番**         | `74x04`  |
| **機能 (EN)**        | Hex inverter    |
| **機能 (JP)**        | 6回路NOTゲート / 6回路インバータ |
| **カテゴリ**         | `01_buffers_inverters`     |
| **入手済み (CMOS)**  | 74HC04AP, 74HCU04AP, SN74HC04N, MM74HC04N/MC74HC04N     |
| **入手済み (TTL)**   | SN74H04N, SN74F04N, SN74AS04N, SN74ALS04BN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x04.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x04.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x04.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x04.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/01_buffers_inverters/74x04/`](../../../usage/01_buffers_inverters/74x04/)
...
- [ ] `usage/01_buffers_inverters/74x04/` のファクトチェックが完了している
