...
| -------------------- | ------------------ |
| **汎用型番**         | `74x14`  |
| **機能 (EN)**        | Hex Schmitt-trigger inverter    |
| **機能 (JP)**        | 6回路シュミットトリガインバータ |
| **カテゴリ**         | `01_buffers_inverters`     |
| **入手済み (CMOS)**  | 74HC14AP, SN74HC14N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x14.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x14.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x14.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x14.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/01_buffers_inverters/74x14/`](../../../usage/01_buffers_inverters/74x14/)
...
- [ ] `usage/01_buffers_inverters/74x14/` のファクトチェックが完了している
