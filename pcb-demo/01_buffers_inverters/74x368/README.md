...
| **入手済み (CMOS)**  | SN74HC368N     |
| **入手済み (TTL)**   | SN74368AN, DM74LS368AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x368.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x368.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x368.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x368.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/01_buffers_inverters/74x368/`](../../../usage/01_buffers_inverters/74x368/)
...
- [ ] `usage/01_buffers_inverters/74x368/` のファクトチェックが完了している
