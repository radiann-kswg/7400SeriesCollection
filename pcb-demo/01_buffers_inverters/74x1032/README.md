...
| -------------------- | ------------------ |
| **汎用型番**         | `74x1032`  |
| **機能 (EN)**        | quad 2-input OR gate (driver series)    |
| **機能 (JP)**        | 2入力OR×4（ドライバ・シリーズ） |
| **カテゴリ**         | `01_buffers_inverters`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74ALS1032AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x1032.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x1032.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x1032.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x1032.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/01_buffers_inverters/74x1032/`](../../../usage/01_buffers_inverters/74x1032/)
...
- [ ] `usage/01_buffers_inverters/74x1032/` のファクトチェックが完了している
