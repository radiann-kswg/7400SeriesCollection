...
| -------------------- | ------------------ |
| **汎用型番**         | `74x265`  |
| **機能 (EN)**        | Quad 2-input exclusive-NOR gate    |
| **機能 (JP)**        | 4回路2入力XNORゲート |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x265.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x265.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x265.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x265.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/04_xor_xnor_gates/74x265/`](../../../usage/04_xor_xnor_gates/74x265/)
...
- [ ] `usage/04_xor_xnor_gates/74x265/` のファクトチェックが完了している
