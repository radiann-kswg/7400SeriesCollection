...
| **入手済み (CMOS)**  | SN74HC161N     |
| **入手済み (TTL)**   | SN74F161AN, SK74LS161      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x161.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x161.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x161.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x161.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/14_system_controllers_timing/74x161/`](../../../usage/14_system_controllers_timing/74x161/)
...
- [ ] `usage/14_system_controllers_timing/74x161/` のファクトチェックが完了している
