...
| -------------------- | ------------------ |
| **汎用型番**         | `74x193`  |
| **機能 (EN)**        | Synchronous up/down binary counter    |
| **機能 (JP)**        | 同期式アップ/ダウンバイナリカウンタ |
| **カテゴリ**         | `14_system_controllers_timing`     |
| **入手済み (CMOS)**  | SN74HC193N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x193.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x193.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x193.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x193.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/14_system_controllers_timing/74x193/`](../../../usage/14_system_controllers_timing/74x193/)
...
- [ ] `usage/14_system_controllers_timing/74x193/` のファクトチェックが完了している
