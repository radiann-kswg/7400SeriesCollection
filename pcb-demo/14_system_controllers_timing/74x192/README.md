...
| -------------------- | ------------------ |
| **汎用型番**         | `74x192`  |
| **機能 (EN)**        | Synchronous up/down decade counter    |
| **機能 (JP)**        | 同期式アップ/ダウン10進カウンタ |
| **カテゴリ**         | `14_system_controllers_timing`     |
| **入手済み (CMOS)**  | CD74HC192E     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x192.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x192.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x192.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x192.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/14_system_controllers_timing/74x192/`](../../../usage/14_system_controllers_timing/74x192/)
...
- [ ] `usage/14_system_controllers_timing/74x192/` のファクトチェックが完了している
