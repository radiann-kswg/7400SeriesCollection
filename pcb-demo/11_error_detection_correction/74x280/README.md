...
| -------------------- | ------------------ |
| **汎用型番**         | `74x280`  |
| **機能 (EN)**        | 9-bit parity generator/checker    |
| **機能 (JP)**        | 9ビットパリティジェネレータ/チェッカ |
| **カテゴリ**         | `11_error_detection_correction`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | 74F280BN, SN74S280N, MC74F280N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x280.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x280.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x280.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x280.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/11_error_detection_correction/74x280/`](../../../usage/11_error_detection_correction/74x280/)
...
- [ ] `usage/11_error_detection_correction/74x280/` のファクトチェックが完了している
