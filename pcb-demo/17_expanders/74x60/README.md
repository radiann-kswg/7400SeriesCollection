...
| -------------------- | ------------------ |
| **汎用型番**         | `74x60`  |
| **機能 (EN)**        | dual 4-input expander for 74x23, 74x50, 74x53, 74x55    |
| **機能 (JP)**        | 2回路4入力拡張器（74x23、74x50、74x53、74x55用） |
| **カテゴリ**         | `17_expanders`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN7460N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x60.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x60.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x60.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x60.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/17_expanders/74x60/`](../../../usage/17_expanders/74x60/)
...
- [ ] `usage/17_expanders/74x60/` のファクトチェックが完了している
