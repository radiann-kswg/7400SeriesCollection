...
| -------------------- | ------------------ |
| **汎用型番**         | `74x182`  |
| **機能 (EN)**        | Lookahead carry generator    |
| **機能 (JP)**        | ルック・アヘッド・キャリー・ジェネレータ |
| **カテゴリ**         | `18_carry_generators`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | SN74S182N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x182.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x182.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x182.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x182.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/18_carry_generators/74x182/`](../../../usage/18_carry_generators/74x182/)
...
- [ ] `usage/18_carry_generators/74x182/` のファクトチェックが完了している
