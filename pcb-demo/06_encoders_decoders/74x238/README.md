...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x238.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x238.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x238.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x238.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x238/`](../../../usage/06_encoders_decoders/74x238/)
...
- [ ] `usage/06_encoders_decoders/74x238/` のファクトチェックが完了している
