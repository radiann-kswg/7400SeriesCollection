...
| -------------------- | ------------------ |
| **汎用型番**         | `74x148`  |
| **機能 (EN)**        | 8-to-3 line priority encoder    |
| **機能 (JP)**        | 8入力3出力プライオリティエンコーダ |
| **カテゴリ**         | `06_encoders_decoders`     |
| **入手済み (CMOS)**  | SN74HC148N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x148.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x148.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x148.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x148.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x148/`](../../../usage/06_encoders_decoders/74x148/)
...
- [ ] `usage/06_encoders_decoders/74x148/` のファクトチェックが完了している
