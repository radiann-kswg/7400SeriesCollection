...
| -------------------- | ------------------ |
| **汎用型番**         | `74x155`  |
| **機能 (EN)**        | dual 2-to-4 line decoder/demultiplexer, inverting outputs    |
| **機能 (JP)**        | 2回路2入力4出力デコーダ/デマルチプレクサ（反転出力） |
| **カテゴリ**         | `06_encoders_decoders`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | 74155N, 74155_DC, SN74LS155AN, DM74155N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x155.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x155.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x155.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x155.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x155/`](../../../usage/06_encoders_decoders/74x155/)
...
- [ ] `usage/06_encoders_decoders/74x155/` のファクトチェックが完了している
