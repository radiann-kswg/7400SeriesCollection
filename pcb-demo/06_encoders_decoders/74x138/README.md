...
| -------------------- | ------------------ |
| **汎用型番**         | `74x138`  |
| **機能 (EN)**        | 3-to-8 line decoder/demultiplexer    |
| **機能 (JP)**        | 3入力8出力デコーダ/デマルチプレクサ |
| **カテゴリ**         | `06_encoders_decoders`     |
| **入手済み (CMOS)**  | 74HC138AP, SN74HC138N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x138.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x138.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x138.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x138.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x138/`](../../../usage/06_encoders_decoders/74x138/)
...
- [ ] `usage/06_encoders_decoders/74x138/` のファクトチェックが完了している
