...
| -------------------- | ------------------ |
| **汎用型番**         | `74x139`  |
| **機能 (EN)**        | Dual 2-to-4 line decoder/demultiplexer    |
| **機能 (JP)**        | 2回路2入力4出力デコーダ/デマルチプレクサ |
| **カテゴリ**         | `06_encoders_decoders`     |
| **入手済み (CMOS)**  | SN74HC139N     |
| **入手済み (TTL)**   | SN74LS139AN      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x139.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x139.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x139.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x139.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x139/`](../../../usage/06_encoders_decoders/74x139/)
...
- [ ] `usage/06_encoders_decoders/74x139/` のファクトチェックが完了している
