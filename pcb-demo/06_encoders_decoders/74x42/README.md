...
| -------------------- | ------------------ |
| **汎用型番**         | `74x42`  |
| **機能 (EN)**        | BCD to decimal decoder    |
| **機能 (JP)**        | BCD-10進デコーダ |
| **カテゴリ**         | `06_encoders_decoders`     |
| **入手済み (CMOS)**  | TC74HC42AP     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x42.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x42.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x42.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x42.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x42/`](../../../usage/06_encoders_decoders/74x42/)
...
- [ ] `usage/06_encoders_decoders/74x42/` のファクトチェックが完了している
