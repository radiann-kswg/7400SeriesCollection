...
| -------------------- | ------------------ |
| **汎用型番**         | `74x154`  |
| **機能 (EN)**        | 4-to-16 line decoder/demultiplexer    |
| **機能 (JP)**        | 4入力16出力デコーダ/デマルチプレクサ |
| **カテゴリ**         | `06_encoders_decoders`     |
| **入手済み (CMOS)**  | CD74HC154EN     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x154.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x154.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x154.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x154.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x154/`](../../../usage/06_encoders_decoders/74x154/)
...
- [ ] `usage/06_encoders_decoders/74x154/` のファクトチェックが完了している
