...
| -------------------- | ------------------ |
| **汎用型番**         | `74x147`  |
| **機能 (EN)**        | 10-to-4 line priority encoder    |
| **機能 (JP)**        | 10入力4出力プライオリティエンコーダ |
| **カテゴリ**         | `06_encoders_decoders`     |
| **入手済み (CMOS)**  | CD74HC147E     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x147.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x147.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x147.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x147.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/06_encoders_decoders/74x147/`](../../../usage/06_encoders_decoders/74x147/)
...
- [ ] `usage/06_encoders_decoders/74x147/` のファクトチェックが完了している
