...
| -------------------- | ------------------ |
| **汎用型番**         | `74x02`  |
| **機能 (EN)**        | Quad 2-input NOR gate    |
| **機能 (JP)**        | 4回路2入力NORゲート |
| **カテゴリ**         | `03_nor_or_gates`     |
| **入手済み (CMOS)**  | 74HC02N, SN74HC02N, HD74HC02F, TC74HC02AF     |
| **入手済み (TTL)**   | 74S02N, SN74F02N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x02.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x02.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x02.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x02.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/03_nor_or_gates/74x02/`](../../../usage/03_nor_or_gates/74x02/)
...
- [ ] `usage/03_nor_or_gates/74x02/` のファクトチェックが完了している
