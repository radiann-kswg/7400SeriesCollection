...
| -------------------- | ------------------ |
| **汎用型番**         | `74x32`  |
| **機能 (EN)**        | Quad 2-input OR gate    |
| **機能 (JP)**        | 4回路2入力ORゲート |
| **カテゴリ**         | `03_nor_or_gates`     |
| **入手済み (CMOS)**  | 74HC32AP, SN74HC32N     |
| **入手済み (TTL)**   | (なし)      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x32.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x32.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x32.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x32.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/03_nor_or_gates/74x32/`](../../../usage/03_nor_or_gates/74x32/)
...
- [ ] `usage/03_nor_or_gates/74x32/` のファクトチェックが完了している
