...
| -------------------- | ------------------ |
| **汎用型番**         | `74x23`  |
| **機能 (EN)**        | dual 4-input NOR gate with strobe, one gate expandable with 74x60    |
| **機能 (JP)**        | 2回路4入力ストローブ付きNORゲート（1ゲートは74x60で拡張可能） |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x23.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x23.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x23.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x23.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/03_nor_or_gates/74x23/`](../../../usage/03_nor_or_gates/74x23/)
...
- [ ] `usage/03_nor_or_gates/74x23/` のファクトチェックが完了している
