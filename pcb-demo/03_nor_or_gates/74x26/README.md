...
| -------------------- | ------------------ |
| **汎用型番**         | `74x26`  |
| **機能 (EN)**        | Quad 2-input NOR gate with open-collector outputs    |
| **機能 (JP)**        | 4回路2入力NORゲート（オープンコレクタ出力） |
| **カテゴリ**         | `03_nor_or_gates`     |
| **入手済み (CMOS)**  | (なし)     |
| **入手済み (TTL)**   | DM7426N, SN74LS26N, HD74LS26P      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x26.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x26.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x26.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x26.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/03_nor_or_gates/74x26/`](../../../usage/03_nor_or_gates/74x26/)
...
- [ ] `usage/03_nor_or_gates/74x26/` のファクトチェックが完了している
