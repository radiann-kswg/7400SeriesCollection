...
| -------------------- | ------------------ |
| **汎用型番**         | `74x27`  |
| **機能 (EN)**        | Triple 3-input NOR gate    |
| **機能 (JP)**        | 3回路3入力NORゲート |
| **カテゴリ**         | `03_nor_or_gates`     |
| **入手済み (CMOS)**  | SN74HC27N     |
| **入手済み (TTL)**   | SN7427N, SN74ALS27N      |
| **入手済み (Other)** | (なし)    |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x27.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x27.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x27.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x27.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/03_nor_or_gates/74x27/`](../../../usage/03_nor_or_gates/74x27/)
...
- [ ] `usage/03_nor_or_gates/74x27/` のファクトチェックが完了している
