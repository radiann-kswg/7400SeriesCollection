...
| -------------------- | ------------------ |
| **汎用型番**         | `74x36`  |
| **機能 (EN)**        | quad 2-input NOR gate (different pinout than 74x02)    |
| **機能 (JP)**        | 4回路2入力NORゲート(74x02と異なるピン配置) |
...
| ファイル                    | 役割                                             |
| --------------------------- | ------------------------------------------------ |
| `74x36.kicad_pro` | KiCAD プロジェクトファイル                       |
| `74x36.kicad_sch` | 回路図（スタブ — 要作成）                        |
| `74x36.kicad_pcb` | PCB レイアウト（50×50mm 外形済み）               |
| `74x36.kicad_sym` | カスタムシンボルスタブ（KiCAD 標準 74xx を推奨） |
...
- 回路設計情報（usage）: [`usage/03_nor_or_gates/74x36/`](../../../usage/03_nor_or_gates/74x36/)
...
- [ ] `usage/03_nor_or_gates/74x36/` のファクトチェックが完了している
