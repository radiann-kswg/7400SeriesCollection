# 74x90 — Decade counter (4-bit, divide-by-10 and divide-by-2 sections)
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS90,SN74LS92,SN74LS93.PDF`
  - URL (SN74LS90N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls90.pdf
