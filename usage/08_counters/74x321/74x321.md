# 74x321 — crystal-controlled oscillators with F/2 and F/4 count-down outputs
...
- **汎用型番**: `74x321`
- **カテゴリ**: `08_counters`
- **機能（EN）**: crystal-controlled oscillators with F/2 and F/4 count-down outputs
- **機能（JP）**: 水晶制御発振器（F/2・F/4の分周出力付）
- **レア度**: `SuperRare`
