# 74x293 — 4-bit binary counter, up/down, separate clocks
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS290,SN74LS293.PDF`
  - URL (SN74LS293N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls293.pdf
