# 74x399 — Dual 4-bit binary counter
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS399.PDF`
  - URL (SN74LS399N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls399.pdf
