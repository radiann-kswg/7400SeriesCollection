# 74x491 — 10-bit binary up/down counter, limited preset, three-state outputs
...
- **汎用型番**: `74x491`
- **カテゴリ**: `08_counters`
- **機能（EN）**: 10-bit binary up/down counter, limited preset, three-state outputs
- **機能（JP）**: 10ビットバイナリアップ/ダウンカウンタ（限定プリセット、3状態）
- **レア度**: `SuperRare`
