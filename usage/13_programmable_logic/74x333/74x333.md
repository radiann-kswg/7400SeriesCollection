# 74x333 — PLA (12 inputs, 32 terms, 6 outputs, 4 state registers), three-state
...
- **機能（EN）**: PLA (12 inputs, 32 terms, 6 outputs, 4 state registers), three-state
- **機能（JP）**: PLA（12入力・32項・6出力・4状態レジスタ）、3状態
- **レア度**: `VeryNerd(UR)`
