# 74x577 — Octal D-type edge-triggered flip-flop, synchronous clear, inverting outputs, three-state
...
- **機能（EN）**: Octal D-type edge-triggered flip-flop, synchronous clear, inverting outputs, three-state
- **機能（JP）**: 8ビットD型エッジトリガFF（同期クリア、反転出力、3状態）
- **レア度**: `Rare`
