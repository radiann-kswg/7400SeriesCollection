...
- **機能（EN）**: Dual 4-bit bistable latch
- **機能（JP）**: 2回路4ビットバイスタブルラッチ
- **レア度**: `Rare`
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - URL (SN74ALS1000AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74als100.pdf
  - URL (SN74ALS1002AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn54als1002a.pdf
