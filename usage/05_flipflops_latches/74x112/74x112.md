# 74x112 — Dual JK flip-flop, negative-edge-triggered, preset and clear
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `SN74HC112N`
  - TTL系: `74LS112N`, `SN74LS112AN`, `HD74LS112P`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74HC/SN74HC112.PDF`
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS112A.PDF`
  - URL (SN74HC112N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74hc112.pdf
  - URL (SN74LS112AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls112a.pdf
- [ ] **ピン配置**（DIP/SOIC/TSSOP など）
- [ ] **真理値表/機能表**（イネーブル極性含む）
- [x] **絶対最大定格/推奨動作条件**（Vcc 範囲、入力電圧、I/O 電流 等）（データシートより自動確認 2026-05-30, 読み取り信頼度 100%）
  - 参照: `datasheets/_download/TI(TexasInstruments)/SN74HC/SN74HC112.PDF`（一次資料）
