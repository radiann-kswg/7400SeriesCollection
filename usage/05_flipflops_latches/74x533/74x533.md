# 74x533 — Octal D-type transparent latch, inverting, 3-state outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `CD74HC533E`, `HD74HC533P`
  - TTL系: `DM74LS533N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC533,CD74HC563.PDF`
  - PDF: `datasheets/_download/RENESAS/HD74HC373,HD74HC533.PDF`
  - URL (CD74HC533E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc533.pdf
