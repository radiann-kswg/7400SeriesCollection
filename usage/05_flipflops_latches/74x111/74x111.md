# 74x111 — Dual JK master-slave flip-flop, data lockout, reset and set
...
- **機能（EN）**: Dual JK master-slave flip-flop, data lockout, reset and set
- **機能（JP）**: 2回路JKマスタ・スレーブFF（データロックアウト、リセット/セット）
- **レア度**: `Maniac(SR+)`
