# 74x598 — 8-bit shift register, selectable parallel-in/out, input latches, three-state
...
- **機能（EN）**: 8-bit shift register, selectable parallel-in/out, input latches, three-state
- **機能（JP）**: 8ビットシフトレジスタ（選択可能な並列入出力、入力ラッチ、3状態）
- **レア度**: `Normal+`
