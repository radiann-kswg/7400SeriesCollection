# 74x103 — Dual JK negative-edge-triggered flip-flop, clear
...
- **機能（EN）**: Dual JK negative-edge-triggered flip-flop, clear
- **機能（JP）**: 2回路JK負エッジトリガFF（クリア）
- **レア度**: `Rare`
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - URL (SN74ALS1032AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74als103.pdf
  - URL (SN74AS1034AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74as1034a.pdf
