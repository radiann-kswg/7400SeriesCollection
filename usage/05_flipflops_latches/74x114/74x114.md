# 74x114 — Dual JK negative-edge-triggered flip-flop, preset, shared clock and clear
...
- **機能（EN）**: Dual JK negative-edge-triggered flip-flop, preset, shared clock and clear
- **機能（JP）**: 2回路JK負エッジトリガFF（プリセット、共有クロック・クリア）
- **レア度**: `Maniac(SR+)`
