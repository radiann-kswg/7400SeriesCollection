# 74x596 — 8-bit shift registers, serial-in, parallel-out, output latches, open-collector
...
- **機能（EN）**: 8-bit shift registers, serial-in, parallel-out, output latches, open-collector
- **機能（JP）**: 8ビットシフトレジスタ（シリアル入力/パラレル出力、出力ラッチ、オープンコレクタ）
- **レア度**: `Rare`
