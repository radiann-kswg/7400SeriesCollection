# 74x375 フリップフロップ/ラッチ 基本動作デモ

> この資料はサンプル回路の解説です。**電気特性・最大定格・入力閾値などは必ず一次資料（データシート）で確認**してください。

## 回路概要

所持している `74x375` 系ICのうち、`SN74LS375N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74LS375N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74ls375.pdf
- **PDF sha256（ローカル）**: `c67ecc33e82e7db58f44cf57871da3e9d0e99e701e8d6ea8e1702fe2cf29897a`
