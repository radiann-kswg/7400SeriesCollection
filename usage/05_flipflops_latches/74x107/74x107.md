# 74x107 — Dual JK flip-flop, negative-edge-triggered, set and reset
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `CD74HC107E`
  - TTL系: `74107PC`, `SN74107N`, `DM74LS107N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC107.PDF`
  - URL (CD74HC107E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc107.pdf
