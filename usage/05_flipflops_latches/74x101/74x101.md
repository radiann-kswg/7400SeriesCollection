# 74x101 — AND-OR-gated JK negative-edge-triggered flip-flop, preset
...
- **機能（EN）**: AND-OR-gated JK negative-edge-triggered flip-flop, preset
- **機能（JP）**: AND-ORゲート付きJK負エッジトリガFF（プリセット）
- **レア度**: `Maniac(SR+)`
