# 74x78 — Dual negative-edge-triggered J-K flip-flop, preset, shared clock and clear
...
- **機能（EN）**: Dual negative-edge-triggered J-K flip-flop, preset, shared clock and clear
- **機能（JP）**: 2回路負エッジトリガJKフリップフロップ（プリセット、共有クロック・クリア）
- **レア度**: `Maniac(SR+)`
