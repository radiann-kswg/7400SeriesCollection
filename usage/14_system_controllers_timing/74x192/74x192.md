# 74x192 — Synchronous up/down decade counter
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC192,CD74HC193.PDF`
  - URL (CD74HC192E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc192.pdf
