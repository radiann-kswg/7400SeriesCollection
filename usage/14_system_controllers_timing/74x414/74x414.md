# 74x414 — Interrupt priority controller for Intel 8080 (8214 equivalent)
...
- **機能（EN）**: Interrupt priority controller for Intel 8080 (8214 equivalent)
- **機能（JP）**: Intel 8080用割込み優先度コントローラ（8214相当）
- **レア度**: `VeryNerd(UR)`
