# 74x323 — 8-bit bidirectional universal shift/storage register, synchronous clear, three-state
...
- **機能（EN）**: 8-bit bidirectional universal shift/storage register, synchronous clear, three-state
- **機能（JP）**: 8ビット双方向ユニバーサルシフト/ストレージレジスタ（同期クリア、3状態）
- **レア度**: `Rare`
