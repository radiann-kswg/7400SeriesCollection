# 74x683 — 8-bit magnitude comparator, P>Q output, 20 kΩ pull-up, open-collector
...
- **機能（EN）**: 8-bit magnitude comparator, P>Q output, 20 kΩ pull-up, open-collector
- **機能（JP）**: 8ビット大小比較器（P>Q出力、20kΩプルアップ、オープンコレクタ）
- **レア度**: `SuperRare`
