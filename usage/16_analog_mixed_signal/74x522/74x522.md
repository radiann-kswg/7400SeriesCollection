# 74x522 — 8-bit comparator, inverting output, 20 kΩ pull-up, open-collector
...
- **機能（EN）**: 8-bit comparator, inverting output, 20 kΩ pull-up, open-collector
- **機能（JP）**: 8ビットコンパレータ（反転出力、20kΩプルアップ、オープンコレクタ）
- **レア度**: `SuperRare`
