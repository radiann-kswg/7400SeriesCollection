# 74x26 — Quad 2-input NOR gate with open-collector outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: （なし）
  - TTL系: `DM7426N`, `SN74LS26N`, `HD74LS26P`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - URL (SN74LS26N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls26.pdf
