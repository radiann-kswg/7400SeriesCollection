...
所持している `74x26` 系ICのうち、`SN74LS26N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74LS26N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74ls26.pdf
- **PDF sha256（ローカル）**: `a959c104efb4f053dc908aac4fdbf8825c61eca6310abb5ddc265c4bce490546`
