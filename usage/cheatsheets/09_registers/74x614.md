# 74x614 — Octal bus transceiver and register, inverting, open-collector
...
- **汎用型番**: `74x614`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver and register, inverting, open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ＋レジスタ（反転、オープンコレクタ）
- **レア度**: `SuperRare`
