# 74x566 — 8-bit bidirectional registered transceiver, inverting, three-state
...
- **汎用型番**: `74x566`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 8-bit bidirectional registered transceiver, inverting, three-state
- **機能（JP）**: 8ビット双方向レジスタ付きトランシーバ（反転、3状態）
- **レア度**: `Rare`
