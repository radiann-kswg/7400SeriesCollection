# 74x658 — Octal bus transceiver with parity, inverting, three-state
...
- **汎用型番**: `74x658`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver with parity, inverting, three-state
- **機能（JP）**: 8ビット・バス・トランシーバ（パリティ付、反転、3状態）
- **レア度**: `Rare`
