# 74x441 — Quad tridirectional bus transceiver, inverting, open-collector
...
- **汎用型番**: `74x441`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Quad tridirectional bus transceiver, inverting, open-collector
- **機能（JP）**: 4回路三方向バストランシーバ（反転、オープンコレクタ）
- **レア度**: `Maniac(SR+)`
