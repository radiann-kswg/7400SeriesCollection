# 74x759 — Quadruple bus transceivers, non-inverting outputs, open-collector
...
- **汎用型番**: `74x759`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Quadruple bus transceivers, non-inverting outputs, open-collector
- **機能（JP）**: 4回路バス・トランシーバ（非反転出力、オープンコレクタ）
- **レア度**: `SuperRare`
