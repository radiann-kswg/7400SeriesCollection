# 74x442 — Quad tridirectional bus transceiver, non-inverting, three-state
...
- **汎用型番**: `74x442`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Quad tridirectional bus transceiver, non-inverting, three-state
- **機能（JP）**: 4回路三方向バストランシーバ（非反転、3状態）
- **レア度**: `Rare`
