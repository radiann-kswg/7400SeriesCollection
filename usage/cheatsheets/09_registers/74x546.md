# 74x546 — 8-bit bidirectional registered transceiver, non-inverting, three-state
...
- **汎用型番**: `74x546`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 8-bit bidirectional registered transceiver, non-inverting, three-state
- **機能（JP）**: 8ビット双方向レジスタ付きトランシーバ（非反転、3状態）
- **レア度**: `SuperRare`
