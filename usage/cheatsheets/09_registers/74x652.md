# 74x652 — Octal bus transceiver/register, non-inverting, three-state
...
- **汎用型番**: `74x652`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver/register, non-inverting, three-state
- **機能（JP）**: 8ビット・バス・トランシーバ/レジスタ（非反転、3状態）
- **レア度**: `SuperRare`
