# 74x286 — 9-bit parity generator/checker, bus driver parity I/O
...
- **汎用型番**: `74x286`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 9-bit parity generator/checker, bus driver parity I/O
- **機能（JP）**: 9ビットパリティ・ジェネレータ/チェッカ（バスドライバ・パリティI/O）
- **レア度**: `VeryNerd(UR)`
