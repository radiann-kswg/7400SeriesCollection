# 74x643 — Octal bus transceiver, mixed inverting/non-inverting, three-state
...
- **汎用型番**: `74x643`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver, mixed inverting/non-inverting, three-state
- **機能（JP）**: 8ビット・バス・トランシーバ（反転/非反転混在、3状態）
- **レア度**: `Rare`
