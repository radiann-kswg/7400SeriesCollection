# 74x657 — Octal bidirectional transceiver with 8-bit parity generator/checker, three-state
...
- **汎用型番**: `74x657`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bidirectional transceiver with 8-bit parity generator/checker, three-state
- **機能（JP）**: 8ビット双方向トランシーバ（8ビット・パリティ生成/検査、3状態）
- **レア度**: `Maniac(SR+)`
