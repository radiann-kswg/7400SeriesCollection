# 74x642 — Octal bus transceiver, inverting outputs, open-collector
...
- **汎用型番**: `74x642`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver, inverting outputs, open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ（反転出力、オープンコレクタ）
- **レア度**: `Rare`
