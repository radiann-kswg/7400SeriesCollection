# 74x331 — PLA (12 inputs, 50 terms, 6 outputs), open-collector with 2.5 kΩ pull-up
...
- **汎用型番**: `74x331`
- **カテゴリ**: `13_programmable_logic`
- **機能（EN）**: PLA (12 inputs, 50 terms, 6 outputs), open-collector with 2.5 kΩ pull-up
- **機能（JP）**: PLA（12入力・50項・6出力）、オープンコレクタ（2.5kΩプルアップ）
- **レア度**: `VeryNerd(UR)`
