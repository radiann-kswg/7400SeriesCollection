# 74x335 — PLA (12 inputs, 32 terms, 6 outputs, 4 state registers), open-collector
...
- **機能（EN）**: PLA (12 inputs, 32 terms, 6 outputs, 4 state registers), open-collector
- **機能（JP）**: PLA（12入力・32項・6出力・4状態レジスタ）、オープンコレクタ
- **レア度**: `VeryNerd(UR)`
