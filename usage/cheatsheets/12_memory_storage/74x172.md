# 74x172 — 16-bit multiple-port register file (8x2), tri-state outputs
...
- **機能（EN）**: 16-bit multiple-port register file (8x2), tri-state outputs
- **機能（JP）**: 16ビットマルチポートレジスタファイル（8×2、3状態出力）
- **レア度**: `VeryNerd(UR)`
