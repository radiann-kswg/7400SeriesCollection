# 74x603 — Dynamic memory refresh controller, cycle steal/burst, for 64K DRAM
...
- **機能（EN）**: Dynamic memory refresh controller, cycle steal/burst, for 64K DRAM
- **機能（JP）**: DRAMリフレッシュコントローラ（サイクルスチール/バースト、64K向け）
- **レア度**: `Maniac(SR+)`
