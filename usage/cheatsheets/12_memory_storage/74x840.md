# 74x840 — field-programmable logic array 14x32x6, open-collector outputs
...
- **機能（EN）**: field-programmable logic array 14x32x6, open-collector outputs
- **機能（JP）**: フィールド・プログラマブル論理アレイ（14×32×6、オープンコレクタ出力）
- **レア度**: `VeryNerd(UR)`
