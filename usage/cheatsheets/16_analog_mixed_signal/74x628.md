# 74x628 — Voltage-controlled oscillator with external temperature compensation
...
- **機能（EN）**: Voltage-controlled oscillator with external temperature compensation
- **機能（JP）**: 電圧制御発振器（外付け温度補償対応）
- **レア度**: `SuperRare`
