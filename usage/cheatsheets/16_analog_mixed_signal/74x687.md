# 74x687 — 8-bit magnitude comparator, P>Q output, enable, open-collector
...
- **機能（EN）**: 8-bit magnitude comparator, P>Q output, enable, open-collector
- **機能（JP）**: 8ビット大小比較器（P>Q出力、イネーブル付、オープンコレクタ）
- **レア度**: `SuperRare`
