# 74x649 — Octal bus transceiver/latch/multiplexer, inverting, open-collector
...
- **機能（EN）**: Octal bus transceiver/latch/multiplexer, inverting, open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ/ラッチ/MUX（反転、オープンコレクタ）
- **レア度**: `Rare`
