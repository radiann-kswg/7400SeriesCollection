# 74x691 — 4-bit binary counter/latch/multiplexer, asynchronous clear, three-state
...
- **機能（EN）**: 4-bit binary counter/latch/multiplexer, asynchronous clear, three-state
- **機能（JP）**: 4ビットバイナリ・カウンタ/ラッチ/MUX（非同期クリア、3状態）
- **レア度**: `Normal+`
