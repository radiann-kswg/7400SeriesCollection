# 74x607 — Octal 2-input multiplexer with latch, glitch-free, open-collector
...
- **機能（EN）**: Octal 2-input multiplexer with latch, glitch-free, open-collector
- **機能（JP）**: 8ビット2入力MUX＋ラッチ（グリッチ低減、オープンコレクタ）
- **レア度**: `Rare`
