# 74x647 — Octal bus transceiver/latch/multiplexer, non-inverting, open-collector
...
- **機能（EN）**: Octal bus transceiver/latch/multiplexer, non-inverting, open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ/ラッチ/MUX（非反転、オープンコレクタ）
- **レア度**: `Rare`
