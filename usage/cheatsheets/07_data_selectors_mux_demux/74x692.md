# 74x692 — 4-bit decimal counter/latch/multiplexer, synchronous clear, three-state
...
- **機能（EN）**: 4-bit decimal counter/latch/multiplexer, synchronous clear, three-state
- **機能（JP）**: 4ビット10進カウンタ/ラッチ/MUX（同期クリア、3状態）
- **レア度**: `Normal+`
