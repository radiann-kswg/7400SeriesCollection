# 74x355 — 8-line to 1-line data selector/multiplexer, transparent registers, open-collector
...
- **機能（EN）**: 8-line to 1-line data selector/multiplexer, transparent registers, open-collector
- **機能（JP）**: 8入力1出力データセレクタ/マルチプレクサ（透過レジスタ、オープンコレクタ）
- **レア度**: `SuperRare`
