# 74x690 — 4-bit decimal counter/latch/multiplexer, asynchronous clear, three-state
...
- **機能（EN）**: 4-bit decimal counter/latch/multiplexer, asynchronous clear, three-state
- **機能（JP）**: 4ビット10進カウンタ/ラッチ/MUX（非同期クリア、3状態）
- **レア度**: `Normal+`
