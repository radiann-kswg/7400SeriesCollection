# 74x351 — dual 8-line to 1-line data selectors/multiplexers, 4 common data inputs, three-state
...
- **機能（EN）**: dual 8-line to 1-line data selectors/multiplexers, 4 common data inputs, three-state
- **機能（JP）**: デュアル8入力1出力データセレクタ/マルチプレクサ（4共通データ入力、3状態）
- **レア度**: `Rare`
