# 74x357 — 8-line to 1-line data selector/multiplexer, edge-triggered registers, open-collector
...
- **機能（EN）**: 8-line to 1-line data selector/multiplexer, edge-triggered registers, open-collector
- **機能（JP）**: 8入力1出力データセレクタ/マルチプレクサ（エッジトリガレジスタ、オープンコレクタ）
- **レア度**: `SuperRare`
