# 74x672 — 4-bit bidirectional shift register/latch/multiplexer, synchronous clear, three-state
...
- **機能（EN）**: 4-bit bidirectional shift register/latch/multiplexer, synchronous clear, three-state
- **機能（JP）**: 4ビット双方向シフトレジスタ/ラッチ/MUX（同期クリア、3状態）
- **レア度**: `SuperRare`
