# 74x39 — Quad 2-input AND buffer/driver with open-collector outputs
...
- **機能（EN）**: Quad 2-input AND buffer/driver with open-collector outputs
- **機能（JP）**: 4回路2入力ANDバッファ/ドライバ（オープンコレクタ出力）
- **レア度**: `Normal+`
