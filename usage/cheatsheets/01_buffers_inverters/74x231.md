# 74x231 — Dual 4-bit buffer/driver (both inverted), pos/neg enable
...
- **機能（EN）**: Dual 4-bit buffer/driver (both inverted), pos/neg enable
- **機能（JP）**: 2回路4ビットバッファ/ドライバ（両方反転）、正/負イネーブル
- **レア度**: `Rare`
