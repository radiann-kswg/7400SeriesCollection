# 74x762 — Octal buffer/line driver, inverting and non-inverting outputs, open-collector
...
- **機能（EN）**: Octal buffer/line driver, inverting and non-inverting outputs, open-collector
- **機能（JP）**: 8ビット バッファ/ラインドライバ（反転/非反転出力、オープンコレクタ）
- **レア度**: `SuperRare`
