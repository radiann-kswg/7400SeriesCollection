# 74x106 — Dual JK negative-edge-triggered flip-flop, preset and clear
...
- **機能（EN）**: Dual JK negative-edge-triggered flip-flop, preset and clear
- **機能（JP）**: 2回路JK負エッジトリガFF（プリセット・クリア）
- **レア度**: `Maniac(SR+)`
