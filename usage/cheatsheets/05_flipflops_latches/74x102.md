# 74x102 — AND-gated JK negative-edge-triggered flip-flop, preset and clear
...
- **機能（EN）**: AND-gated JK negative-edge-triggered flip-flop, preset and clear
- **機能（JP）**: ANDゲート付きJK負エッジトリガFF（プリセット・クリア）
- **レア度**: `Maniac(SR+)`
