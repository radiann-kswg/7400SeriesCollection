# 74x547 — 8-bit bidirectional latched transceiver, non-inverting, three-state
...
- **機能（EN）**: 8-bit bidirectional latched transceiver, non-inverting, three-state
- **機能（JP）**: 8ビット双方向ラッチ付きトランシーバ（非反転、3状態）
- **レア度**: `SuperRare`
