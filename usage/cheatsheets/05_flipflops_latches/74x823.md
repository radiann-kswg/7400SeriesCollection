# 74x823 — 9-bit D-type flip-flops with clear and clock enable
...
- **機能（EN）**: 9-bit D-type flip-flops with clear and clock enable
- **機能（JP）**: 9ビット D型フリップフロップ（クリア・クロックイネーブル付）
- **レア度**: `Rare`
