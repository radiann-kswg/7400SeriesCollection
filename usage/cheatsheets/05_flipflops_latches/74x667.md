# 74x667 — 8-bit D-type transparent read-back latch, inverting, three-state
...
- **機能（EN）**: 8-bit D-type transparent read-back latch, inverting, three-state
- **機能（JP）**: 8ビットD型透過リードバック・ラッチ（反転、3状態）
- **レア度**: `SuperRare`
