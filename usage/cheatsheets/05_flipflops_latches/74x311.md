# 74x311 — 144-bit RAM (16x9) with output latch, open-collector outputs
...
- **機能（EN）**: 144-bit RAM (16x9) with output latch, open-collector outputs
- **機能（JP）**: 144ビットRAM (16x9)、出力ラッチ付、オープンコレクタ出力
- **レア度**: `ManiacRare(SSR)`
