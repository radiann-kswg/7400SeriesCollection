# 74x412 — Multi-mode buffered 8-bit latches (Intel 3212/8212 equivalent)
...
- **機能（EN）**: Multi-mode buffered 8-bit latches (Intel 3212/8212 equivalent)
- **機能（JP）**: 多モードバッファ付き8ビットラッチ（Intel 3212/8212相当）
- **レア度**: `Rare`
