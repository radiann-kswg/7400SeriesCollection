# 74x580 — Octal D-type transparent latch, inverting outputs, three-state
...
- **機能（EN）**: Octal D-type transparent latch, inverting outputs, three-state
- **機能（JP）**: 8ビットD型透過ラッチ（反転出力、3状態）
- **レア度**: `Rare`
