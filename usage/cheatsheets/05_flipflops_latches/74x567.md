# 74x567 — 8-bit bidirectional latched transceiver, inverting, three-state
...
- **機能（EN）**: 8-bit bidirectional latched transceiver, inverting, three-state
- **機能（JP）**: 8ビット双方向ラッチ付きトランシーバ（反転、3状態）
- **レア度**: `Rare`
