# 74x239 — Dual 2-to-4 decoder/demultiplexer, active-high outputs
...
- **機能（EN）**: Dual 2-to-4 decoder/demultiplexer, active-high outputs
- **機能（JP）**: 2回路2入力4出力デコーダ/デマルチ（アクティブHigh出力）
- **レア度**: `Rare`
