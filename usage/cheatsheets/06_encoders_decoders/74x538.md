# 74x538 — 3-to-8 line decoder/demultiplexer, three-state outputs
...
- **機能（EN）**: 3-to-8 line decoder/demultiplexer, three-state outputs
- **機能（JP）**: 3入力8出力デコーダ/デマルチプレクサ（3状態出力）
- **レア度**: `Normal+`
