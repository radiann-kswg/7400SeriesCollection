# 74x46 — BCD to 7-segment decoder/driver, open-collector (30 V)
...
- **機能（EN）**: BCD to 7-segment decoder/driver, open-collector (30 V)
- **機能（JP）**: BCD-7セグメントデコーダ/ドライバ（オープンコレクタ、30V）
- **レア度**: `Rare`
