# 74x45 — BCD to decimal decoder/driver, open-collector (30 V / 80 mA)
...
- **機能（EN）**: BCD to decimal decoder/driver, open-collector (30 V / 80 mA)
- **機能（JP）**: BCD-10進デコーダ/ドライバ（オープンコレクタ、30V/80mA）
- **レア度**: `Rare`
