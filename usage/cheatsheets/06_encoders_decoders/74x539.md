# 74x539 — Dual 2-to-4 line decoder/demultiplexer, three-state outputs
...
- **機能（EN）**: Dual 2-to-4 line decoder/demultiplexer, three-state outputs
- **機能（JP）**: 2回路2入力4出力デコーダ/デマルチプレクサ（3状態出力）
- **レア度**: `Normal+`
