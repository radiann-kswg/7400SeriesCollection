# 74x616 — 16-bit parallel error detection and correction (EDAC), three-state
...
- **機能（EN）**: 16-bit parallel error detection and correction (EDAC), three-state
- **機能（JP）**: 16ビット並列EDAC（誤り検出訂正、3状態）
- **レア度**: `Maniac(SR+)`
