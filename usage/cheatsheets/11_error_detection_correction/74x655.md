# 74x655 — Octal buffer/line driver with parity, inverting, three-state
...
- **機能（EN）**: Octal buffer/line driver with parity, inverting, three-state
- **機能（JP）**: 8ビット・バッファ/ラインドライバ（パリティ付、反転、3状態）
- **レア度**: `Rare`
