# 74x617 — 16-bit parallel error detection and correction (EDAC), open-collector
...
- **機能（EN）**: 16-bit parallel error detection and correction (EDAC), open-collector
- **機能（JP）**: 16ビット並列EDAC（誤り検出訂正、オープンコレクタ）
- **レア度**: `Maniac(SR+)`
