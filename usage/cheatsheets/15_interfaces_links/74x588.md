# 74x588 — Octal bidirectional transceiver with IEEE-488 termination resistors, three-state
...
- **汎用型番**: `74x588`
- **カテゴリ**: `15_interfaces_links`
- **機能（EN）**: Octal bidirectional transceiver with IEEE-488 termination resistors, three-state
- **機能（JP）**: IEEE-488終端抵抗付き8ビット双方向トランシーバ（3状態）
- **レア度**: `Maniac(SR+)`
