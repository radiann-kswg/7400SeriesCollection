# 74x469 — 8-bit synchronous up/down counter, with parallel load and hold
...
- **機能（EN）**: 8-bit synchronous up/down counter, with parallel load and hold
- **機能（JP）**: 8ビット同期式アップ/ダウンカウンタ（パラレルロード/ホールド）
- **レア度**: `Rare`
