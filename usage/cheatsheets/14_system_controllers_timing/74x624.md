# 74x624 — Voltage-controlled oscillator, enable/range control, two-phase outputs
...
- **機能（EN）**: Voltage-controlled oscillator, enable/range control, two-phase outputs
- **機能（JP）**: 電圧制御発振器（有効/レンジ制御、2相出力）
- **レア度**: `SuperRare`
