# 74x179 — 4-bit parallel-access shift register with asynchronous clear, complementary Qd output
...
- **機能（EN）**: 4-bit parallel-access shift register with asynchronous clear, complementary Qd output
- **機能（JP）**: 4ビット並列アクセスシフトレジスタ（非同期クリア、補助Qd出力）
- **レア度**: `Rare`
