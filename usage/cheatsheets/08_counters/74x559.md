# 74x559 — 8-bit expandable two's complement multiplier/divider, three-state
...
- **汎用型番**: `74x559`
- **カテゴリ**: `08_counters`
- **機能（EN）**: 8-bit expandable two's complement multiplier/divider, three-state
- **機能（JP）**: 拡張可能8ビット2の補数 乗算/除算器（3状態）
- **レア度**: `Maniac(SR+)`
