# 74x417 — Modulo-2 and modulo-5 counters, shared preload and clear
...
- **汎用型番**: `74x417`
- **カテゴリ**: `08_counters`
- **機能（EN）**: Modulo-2 and modulo-5 counters, shared preload and clear
- **機能（JP）**: モジュロ2/5カウンタ（プリロード・クリア共用）
- **レア度**: `Maniac(SR+)`
