# 74x37 — Quad 2-input NAND buffer/driver with open-collector outputs
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS37.PDF`
  - URL (SN74LS37N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls37.pdf
