...
所持している `74x37` 系ICのうち、`SN74LS37N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74LS37N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74ls37.pdf
- **PDF sha256（ローカル）**: `1dc2e64ff10442577718c45ed7e6605674d6ea478d87e5efaa287ece31cd7781`
