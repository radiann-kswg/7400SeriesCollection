# 74x05 — Hex inverter with open-collector outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `SN74HC05N`
  - TTL系: `SN74LS05N`, `SN74ALS05N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74HC/SN74HC05.PDF`
  - URL (SN74ALS05N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74als05a.pdf
  - URL (SN74HC05N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74hc05.pdf
  - URL (SN74LS05N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls05.pdf
- [x] **ピン配置**（DIP/SOIC/TSSOP など）（データシートより自動確認 2026-05-30, 読み取り信頼度 86%）
  - VCC: Pin 6
  - 参照: (PDF 参照) Pin Configuration（一次資料）
  - 参照: `datasheets/_download/TI(TexasInstruments)/SN74HC/SN74HC05.PDF`（一次資料）
- [ ] **真理値表/機能表**（イネーブル極性含む）
