# 74x310 — octal buffer, inverting outputs, Schmitt-trigger inputs, three-state
...
- **機能（EN）**: octal buffer, inverting outputs, Schmitt-trigger inputs, three-state
- **機能（JP）**: 8ビットバッファ（反転出力、シュミットトリガ入力、3状態）
- **レア度**: `Rare`
