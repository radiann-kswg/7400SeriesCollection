...
所持している `74x38` 系ICのうち、`SN74LS38N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74LS38N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74ls38.pdf
- **PDF sha256（ローカル）**: `53d9455f5808a9a8c7c150b918bc7f39da1fd35a67e1ee232151cd10bfdb1d8b`
