# 74x38 — Quad 2-input NAND buffer/driver with open-collector outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: （なし）
  - TTL系: `SN74LS38N`, `MC74F38N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS38.PDF`
  - URL (SN74LS38N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls38.pdf
