# 74x366 — Hex buffer/line driver, inverting, 3-state outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `CD74HC366E`
  - TTL系: `SN74366AN`, `DM74LS366AN`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC365,CD74HC366.PDF`
  - URL (CD74HC366E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc366.pdf
- [x] **ピン配置**（DIP/SOIC/TSSOP など）（データシートより自動確認 2026-05-30, 読み取り信頼度 86%）
  - 参照: (PDF 参照) Pin Configuration（一次資料）
  - 参照: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC365,CD74HC366.PDF`（一次資料）
