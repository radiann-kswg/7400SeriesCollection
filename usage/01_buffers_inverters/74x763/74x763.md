# 74x763 — Octal buffer/line driver, inverting outputs, complementary enables, open-collector
...
- **機能（EN）**: Octal buffer/line driver, inverting outputs, complementary enables, open-collector
- **機能（JP）**: 8ビット バッファ/ラインドライバ（反転出力、相補イネーブル、オープンコレクタ）
- **レア度**: `SuperRare`
