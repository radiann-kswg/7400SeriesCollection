...
所持している `74x365` 系ICのうち、`SN74HC365N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74HC365N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74hc365.pdf
- **PDF sha256（ローカル）**: `f30731c0087c895cf40dd0fe12bee0444ad06bc49a03cd7d6661a219a028e58c`
