...
所持している `74x241` 系ICのうち、`SN74HC241N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74HC241N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74hc241.pdf
- **PDF sha256（ローカル）**: `b9cc37865a7e070458fe736d9b28d44e41157675205d3ba34bcd39172b5e8532`
