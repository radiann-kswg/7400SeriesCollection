# 74x240 — Octal buffer/line driver, inverting, 3-state outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `74HC240AP`
  - TTL系: `74F240PC`, `SN74LS240N`, `SN74ALS240AN`, `MC74F240N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - URL (SN74ALS240AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74als240a.pdf
  - URL (SN74LS240N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls240.pdf
