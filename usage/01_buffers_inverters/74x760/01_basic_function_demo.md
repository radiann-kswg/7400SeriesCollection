...
所持している `74x760` 系ICのうち、`SN74AS760N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74AS760N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74as760.pdf
- **PDF sha256（ローカル）**: `88dd9c6a3f5ae43e1c78e6d2210e0db1ca23ce89bdedc0d2bb7533a1b4eea153`
