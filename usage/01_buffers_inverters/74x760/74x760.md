# 74x760 — Octal buffer/line driver, non-inverting, open-collector
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: （なし）
  - TTL系: `SN74AS760N`, `SN74ALS760N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - URL (SN74ALS760N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74als760.pdf
  - URL (SN74AS760N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74as760.pdf
