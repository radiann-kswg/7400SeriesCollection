# 74x436 — MOS memory interface line/memory driver (damping resistor)
...
- **機能（EN）**: MOS memory interface line/memory driver (damping resistor)
- **機能（JP）**: MOSメモリIF用ライン/メモリドライバ（ダンピング抵抗）
- **レア度**: `Rare`
