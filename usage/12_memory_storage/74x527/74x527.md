# 74x527 — Fuse programmable identity comparator, 8-bit + 4-bit conventional
...
- **機能（EN）**: Fuse programmable identity comparator, 8-bit + 4-bit conventional
- **機能（JP）**: ヒューズ・プログラマブル同一性コンパレータ（8ビット＋通常4ビット）
- **レア度**: `VeryNerd(UR)`
