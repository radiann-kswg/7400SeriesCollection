# 74x602 — Dynamic memory refresh controller, cycle steal/burst, for 4K/16K DRAM
...
- **機能（EN）**: Dynamic memory refresh controller, cycle steal/burst, for 4K/16K DRAM
- **機能（JP）**: DRAMリフレッシュコントローラ（サイクルスチール/バースト、4K/16K向け）
- **レア度**: `Maniac(SR+)`
