# 74x315 — 1024-bit RAM (1024x1) with power-down mode, open-collector outputs
...
- **機能（EN）**: 1024-bit RAM (1024x1) with power-down mode, open-collector outputs
- **機能（JP）**: 1024ビットRAM (1024x1)、省電力モード付、オープンコレクタ出力
- **レア度**: `ManiacRare(SSR)`
