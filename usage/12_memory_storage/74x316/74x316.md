# 74x316 — 256-bit RAM (64x4), common I/O, open-collector outputs
...
- **機能（EN）**: 256-bit RAM (64x4), common I/O, open-collector outputs
- **機能（JP）**: 256ビットRAM (64x4)、共用I/O、オープンコレクタ出力
- **レア度**: `ManiacRare(SSR)`
