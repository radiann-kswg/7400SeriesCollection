# 74x89 — 64-bit RAM (16x4), inverted data outputs, open-collector
...
- **機能（EN）**: 64-bit RAM (16x4), inverted data outputs, open-collector
- **機能（JP）**: 64ビットRAM（16×4、反転データ出力、オープンコレクタ）
- **レア度**: `ManiacRare(SSR)`
