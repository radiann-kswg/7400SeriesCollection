# 74x65 — 4-3-2-2-input AND-OR-Invert gate, open-collector outputs
...
- **機能（EN）**: 4-3-2-2-input AND-OR-Invert gate, open-collector outputs
- **機能（JP）**: 4-3-2-2入力AND-OR-インバートゲート（オープンコレクタ出力）
- **レア度**: `Maniac(SR+)`
