...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `SN74HC30N`
  - TTL系: `74F30PC`, `SN74H30N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - URL (SN74H30N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74h30.pdf
  - URL (SN74HC30N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74hc30.pdf
