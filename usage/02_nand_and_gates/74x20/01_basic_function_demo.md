...
所持している `74x20` 系ICのうち、`SN74LS20N`（DIP想定）を使って、最小構成で基本動作を確認する回路です。
...
- **実型番**: `SN74LS20N`
- **データシートURL**: https://www.ti.com/lit/ds/symlink/sn74ls20.pdf
- **PDF sha256（ローカル）**: `ba7e3e04eff2e54ac0cb12bf2f555cbb4eba6f96a7c80f11eb9a9c45f603ff40`
