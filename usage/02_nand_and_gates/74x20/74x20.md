...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `74HC20AP`
  - TTL系: `74F20N`, `SN74LS20N`, `DM74S20N`, `DM74LS20N`, `MC74F20N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS20.PDF`
  - URL (SN74LS20N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls20.pdf
