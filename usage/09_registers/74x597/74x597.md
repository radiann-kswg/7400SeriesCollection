# 74x597 — 8-bit parallel-in/serial-out shift register
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC597.PDF`
  - URL (CD74HC597E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc597.pdf
