# 74x593 — 8-bit binary counter with input registers, three-state
...
- **汎用型番**: `74x593`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 8-bit binary counter with input registers, three-state
- **機能（JP）**: 8ビットバイナリカウンタ（入力レジスタ付き、3状態）
- **レア度**: `Rare`
