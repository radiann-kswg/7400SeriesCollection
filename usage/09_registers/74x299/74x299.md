# 74x299 — 8-bit universal shift/storage register
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS299.PDF`
  - URL (SN74LS299N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls299.pdf
