# 74x444 — Quad tridirectional bus transceiver, inverting and non-inverting, three-state
...
- **汎用型番**: `74x444`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Quad tridirectional bus transceiver, inverting and non-inverting, three-state
- **機能（JP）**: 4回路三方向バストランシーバ（反転/非反転混在、3状態）
- **レア度**: `SuperRare`
