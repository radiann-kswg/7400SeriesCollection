# 74x380 — 8-bit multifunction register (combines features of x374, x377, x273, x534 ICs), three-state
...
- **汎用型番**: `74x380`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 8-bit multifunction register (combines features of x374, x377, x273, x534 ICs), three-state
- **機能（JP）**: 8ビット多機能レジスタ（x374/x377/x273/x534の機能統合）、3状態
- **レア度**: `ManiacRare(SSR)`
