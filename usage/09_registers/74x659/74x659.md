# 74x659 — Octal bus transceiver with parity, non-inverting, three-state
...
- **汎用型番**: `74x659`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver with parity, non-inverting, three-state
- **機能（JP）**: 8ビット・バス・トランシーバ（パリティ付、非反転、3状態）
- **レア度**: `Rare`
