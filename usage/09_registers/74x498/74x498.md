# 74x498 — 8-bit bidirectional shift register with parallel inputs
...
- **汎用型番**: `74x498`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 8-bit bidirectional shift register with parallel inputs
- **機能（JP）**: 8ビット双方向シフトレジスタ（パラレル入力）
- **レア度**: `Rare`
