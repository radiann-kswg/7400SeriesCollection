# 74x166 — 8-bit parallel-in/serial-out shift register
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC166.PDF`
  - URL (CD74HC166E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc166.pdf
...
- [x] **電気特性**（VIH/VIL, VOH/VOL, IOL/IOH, tpd など）（データシートより自動確認 2026-05-30, 読み取り信頼度 100%）
  - 参照: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC166.PDF`（一次資料）
