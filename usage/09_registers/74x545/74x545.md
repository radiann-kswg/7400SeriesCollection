# 74x545 — Octal bidirectional transceiver, non-inverting, three-state
...
- **汎用型番**: `74x545`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bidirectional transceiver, non-inverting, three-state
- **機能（JP）**: 8ビット双方向トランシーバ（非反転、3状態）
- **レア度**: `Rare`
