# 74x448 — Quad tridirectional bus transceiver, inverting and non-inverting, open-collector
...
- **汎用型番**: `74x448`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Quad tridirectional bus transceiver, inverting and non-inverting, open-collector
- **機能（JP）**: 4回路三方向バストランシーバ（反転/非反転混在、オープンコレクタ）
- **レア度**: `SuperRare`
