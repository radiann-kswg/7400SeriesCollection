# 74x552 — Octal registered transceiver with parity and flags, three-state
...
- **汎用型番**: `74x552`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal registered transceiver with parity and flags, three-state
- **機能（JP）**: パリティ/フラグ付き8ビットレジスタ・トランシーバ（3状態）
- **レア度**: `Maniac(SR+)`
