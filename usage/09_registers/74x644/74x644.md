# 74x644 — Octal bus transceiver, mixed inverting/non-inverting, open-collector
...
- **汎用型番**: `74x644`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver, mixed inverting/non-inverting, open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ（反転/非反転混在、オープンコレクタ）
- **レア度**: `Rare`
