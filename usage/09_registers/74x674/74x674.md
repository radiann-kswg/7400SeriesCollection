# 74x674 — 16-bit parallel-in, serial-out shift register, three-state
...
- **汎用型番**: `74x674`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 16-bit parallel-in, serial-out shift register, three-state
- **機能（JP）**: 16ビットPISOシフトレジスタ（3状態）
- **レア度**: `Maniac(SR+)`
