# 74x641 — Octal bus transceiver, non-inverting outputs, open-collector
...
- **汎用型番**: `74x641`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver, non-inverting outputs, open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ（非反転出力、オープンコレクタ）
- **レア度**: `Rare`
