# 74x638 — Octal bus transceiver, inverting outputs, three-state/open-collector
...
- **汎用型番**: `74x638`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver, inverting outputs, three-state/open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ（反転出力、3状態/オープンコレクタ）
- **レア度**: `Rare`
