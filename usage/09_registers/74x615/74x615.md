# 74x615 — Octal bus transceiver and register, non-inverting, open-collector
...
- **汎用型番**: `74x615`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver and register, non-inverting, open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ＋レジスタ（非反転、オープンコレクタ）
- **レア度**: `SuperRare`
