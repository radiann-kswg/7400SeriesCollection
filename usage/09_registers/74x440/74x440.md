# 74x440 — Quad tridirectional bus transceiver, non-inverting, open-collector
...
- **汎用型番**: `74x440`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Quad tridirectional bus transceiver, non-inverting, open-collector
- **機能（JP）**: 4回路三方向バストランシーバ（非反転、オープンコレクタ）
- **レア度**: `Maniac(SR+)`
