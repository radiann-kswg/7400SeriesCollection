# 74x591 — 8-bit binary counter with output registers, open-collector
...
- **汎用型番**: `74x591`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 8-bit binary counter with output registers, open-collector
- **機能（JP）**: 8ビットバイナリカウンタ（出力レジスタ付き、オープンコレクタ）
- **レア度**: `Rare`
