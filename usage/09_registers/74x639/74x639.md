# 74x639 — Octal bus transceiver, non-inverting outputs, three-state/open-collector
...
- **汎用型番**: `74x639`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver, non-inverting outputs, three-state/open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ（非反転出力、3状態/オープンコレクタ）
- **レア度**: `Rare`
