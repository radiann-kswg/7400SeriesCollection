# 74x95 — 4-bit shift register, parallel in/parallel out, serial input
...
- **汎用型番**: `74x95`
- **カテゴリ**: `09_registers`
- **機能（EN）**: 4-bit shift register, parallel in/parallel out, serial input
- **機能（JP）**: 4ビットシフトレジスタ（パラレル入出力、シリアル入力）
- **レア度**: `Abolition(R+)`
