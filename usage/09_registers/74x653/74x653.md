# 74x653 — Octal bus transceiver/register, inverting, three-state/open-collector
...
- **汎用型番**: `74x653`
- **カテゴリ**: `09_registers`
- **機能（EN）**: Octal bus transceiver/register, inverting, three-state/open-collector
- **機能（JP）**: 8ビット・バス・トランシーバ/レジスタ（反転、3状態/オープンコレクタ）
- **レア度**: `SuperRare`
