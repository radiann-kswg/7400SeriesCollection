# 74x631 — 16-bit error detection and correction (EDAC), open-collector
...
- **機能（EN）**: 16-bit error detection and correction (EDAC), open-collector
- **機能（JP）**: 16ビットEDAC（オープンコレクタ）
- **レア度**: `Maniac(SR+)`
