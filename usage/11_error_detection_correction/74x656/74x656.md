# 74x656 — Octal buffer/line driver with parity, non-inverting, three-state
...
- **機能（EN）**: Octal buffer/line driver with parity, non-inverting, three-state
- **機能（JP）**: 8ビット・バッファ/ラインドライバ（パリティ付、非反転、3状態）
- **レア度**: `Rare`
