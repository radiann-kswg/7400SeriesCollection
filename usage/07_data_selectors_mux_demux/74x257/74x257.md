# 74x257 — Quad 2-to-1 multiplexer with 3-state outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `SN74HC257N`
  - TTL系: `74LS257AN`, `74F257AN`, `SN74ALS257AN`, `SN74F257N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74HC/SN74HC257,SN74HC258.PDF`
  - URL (SN74ALS257AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74als257a.pdf
  - URL (SN74F257N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74f257.pdf
  - URL (SN74HC257N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74hc257.pdf
- [ ] **ピン配置**（DIP/SOIC/TSSOP など）
- [ ] **真理値表/機能表**（イネーブル極性含む）
- [x] **絶対最大定格/推奨動作条件**（Vcc 範囲、入力電圧、I/O 電流 等）（データシートより自動確認 2026-05-30, 読み取り信頼度 100%）
  - 参照: `datasheets/_download/TI(TexasInstruments)/SN74HC/SN74HC257,SN74HC258.PDF`（一次資料）
