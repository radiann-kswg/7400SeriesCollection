# 74x671 — 4-bit bidirectional shift register/latch/multiplexer, direct clear, three-state
...
- **機能（EN）**: 4-bit bidirectional shift register/latch/multiplexer, direct clear, three-state
- **機能（JP）**: 4ビット双方向シフトレジスタ/ラッチ/MUX（直接クリア、3状態）
- **レア度**: `SuperRare`
