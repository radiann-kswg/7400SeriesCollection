# 74x606 — Octal 2-input multiplexer with latch, glitch-free, three-state
...
- **機能（EN）**: Octal 2-input multiplexer with latch, glitch-free, three-state
- **機能（JP）**: 8ビット2入力MUX＋ラッチ（グリッチ低減、3状態）
- **レア度**: `Rare`
