# 74x646 — Octal bus transceiver/latch/multiplexer, non-inverting, three-state
...
- **機能（EN）**: Octal bus transceiver/latch/multiplexer, non-inverting, three-state
- **機能（JP）**: 8ビット・バス・トランシーバ/ラッチ/MUX（非反転、3状態）
- **レア度**: `Rare`
