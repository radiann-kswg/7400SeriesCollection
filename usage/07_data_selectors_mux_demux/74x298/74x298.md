# 74x298 — Quad 2-input multiplexer/quad 2-bit bidirectional universal shift register
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: （なし）
  - TTL系: `SN74LS298N`, `SN74298N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS298.PDF`
  - URL (SN74LS298N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls298.pdf
