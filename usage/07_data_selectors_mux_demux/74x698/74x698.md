# 74x698 — 4-bit decimal counter/register/multiplexer, synchronous clear, three-state
...
- **機能（EN）**: 4-bit decimal counter/register/multiplexer, synchronous clear, three-state
- **機能（JP）**: 4ビット10進カウンタ/レジスタ/MUX（同期クリア、3状態）
- **レア度**: `Normal+`
