# 74x353 — dual 4-line to 1-line data selectors/multiplexers, inverting outputs, three-state
...
- **機能（EN）**: dual 4-line to 1-line data selectors/multiplexers, inverting outputs, three-state
- **機能（JP）**: デュアル4入力1出力データセレクタ/マルチプレクサ（反転出力、3状態）
- **レア度**: `Rare`
