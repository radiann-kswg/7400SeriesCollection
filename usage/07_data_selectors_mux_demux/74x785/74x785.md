# 74x785 — Display address multiplexer with 256-column refresh
...
- **機能（EN）**: Display address multiplexer with 256-column refresh
- **機能（JP）**: 表示システム向け アドレスマルチプレクサ（256列リフレッシュ）
- **レア度**: `Maniac(SR+)`
