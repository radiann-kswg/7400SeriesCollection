# 74x693 — 4-bit binary counter/latch/multiplexer, synchronous clear, three-state
...
- **機能（EN）**: 4-bit binary counter/latch/multiplexer, synchronous clear, three-state
- **機能（JP）**: 4ビットバイナリ・カウンタ/ラッチ/MUX（同期クリア、3状態）
- **レア度**: `Normal+`
