# 74x253 — Dual 4-to-1 multiplexer with 3-state outputs
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC253.PDF`
  - URL (CD74HC253E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc253.pdf
