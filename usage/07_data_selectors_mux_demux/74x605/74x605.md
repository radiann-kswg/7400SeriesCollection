# 74x605 — Octal 2-input multiplexer with latch, high-speed, open-collector
...
- **機能（EN）**: Octal 2-input multiplexer with latch, high-speed, open-collector
- **機能（JP）**: 8ビット2入力MUX＋ラッチ（高速、オープンコレクタ）
- **レア度**: `Rare`
