# 74x354 — 8-to-1 data selector/multiplexer, transparent registers
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `CD74HC354E`, `HD74HC354P`
  - TTL系: （なし）
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC354.PDF`
  - PDF: `datasheets/_download/RENESAS/HD74HC354.PDF`
  - URL (CD74HC354E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc354.pdf
