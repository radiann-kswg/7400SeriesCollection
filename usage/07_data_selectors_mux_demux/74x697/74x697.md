# 74x697 — 4-bit binary counter/register/multiplexer, asynchronous clear, three-state
...
- **機能（EN）**: 4-bit binary counter/register/multiplexer, asynchronous clear, three-state
- **機能（JP）**: 4ビットバイナリ・カウンタ/レジスタ/MUX（非同期クリア、3状態）
- **レア度**: `Normal+`
