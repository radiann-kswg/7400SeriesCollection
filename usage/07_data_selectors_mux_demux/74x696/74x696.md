# 74x696 — 4-bit decimal counter/register/multiplexer, asynchronous clear, three-state
...
- **機能（EN）**: 4-bit decimal counter/register/multiplexer, asynchronous clear, three-state
- **機能（JP）**: 4ビット10進カウンタ/レジスタ/MUX（非同期クリア、3状態）
- **レア度**: `Normal+`
