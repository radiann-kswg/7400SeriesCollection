# 74x604 — Octal 2-input multiplexer with latch, high-speed, three-state
...
- **機能（EN）**: Octal 2-input multiplexer with latch, high-speed, three-state
- **機能（JP）**: 8ビット2入力MUX＋ラッチ（高速、3状態）
- **レア度**: `Rare`
