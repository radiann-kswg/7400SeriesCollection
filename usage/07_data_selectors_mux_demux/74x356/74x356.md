# 74x356 — 8-to-1 data selector/multiplexer, edge-triggered registers
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: `TC74HC356P`, `CD74HCT356E`
  - TTL系: （なし）
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HCT356.PDF`
  - URL (CD74HCT356E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hct356.pdf
