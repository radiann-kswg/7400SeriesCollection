# 74x347 — BCD to 7-segment decoders/drivers, low voltage version of 7447, open-collector
...
- **機能（EN）**: BCD to 7-segment decoders/drivers, low voltage version of 7447, open-collector
- **機能（JP）**: BCD-7セグメントデコーダ/ドライバ（7447の低電圧版、オープンコレクタ）
- **レア度**: `Rare`
