# 74x47 — BCD to 7-segment decoder/driver (open-collector outputs)
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS47.PDF`
  - URL (SN74LS47N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls47.pdf
