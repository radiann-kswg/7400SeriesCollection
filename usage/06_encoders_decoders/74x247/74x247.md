# 74x247 — BCD to 7-segment decoder/driver (open-collector outputs)
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS246,SN74LS247,SN74LS248.PDF`
  - URL (SN74LS247N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls247.pdf
