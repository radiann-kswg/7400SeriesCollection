# 74x137 — 3-to-8 line decoder/demultiplexer with address latches
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC137,CD74HC237.PDF`
  - URL (CD74HC137E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc137.pdf
