# 74x144 — Decade counter/latch/decoder/7-segment driver, open-collector outputs
...
- **機能（EN）**: Decade counter/latch/decoder/7-segment driver, open-collector outputs
- **機能（JP）**: 10進カウンタ/ラッチ/デコーダ/7セグドライバ（オープンコレクタ）
- **レア度**: `Rare`
