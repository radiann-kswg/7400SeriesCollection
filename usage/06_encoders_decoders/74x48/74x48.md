# 74x48 — BCD to 7-segment decoder/driver, open-collector with 2 kΩ pull-up
...
- **機能（EN）**: BCD to 7-segment decoder/driver, open-collector with 2 kΩ pull-up
- **機能（JP）**: BCD-7セグメントデコーダ/ドライバ（オープンコレクタ、2kΩプルアップ内蔵）
- **レア度**: `Rare`
