...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS145.PDF`
  - URL (SN74LS145N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls145.pdf
