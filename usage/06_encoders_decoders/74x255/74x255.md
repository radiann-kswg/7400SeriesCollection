# 74x255 — Dual 2-to-4 decoder/demux, inverting outputs, tri-state
...
- **機能（EN）**: Dual 2-to-4 decoder/demux, inverting outputs, tri-state
- **機能（JP）**: 2回路2入力4出力デコーダ/デマルチ（反転出力、3状態）
- **レア度**: `VeryNerd(UR)`
