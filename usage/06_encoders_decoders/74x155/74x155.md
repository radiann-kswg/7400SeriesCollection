...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: （なし）
  - TTL系: `74155N`, `74155_DC`, `SN74LS155AN`, `DM74155N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/_cache/SN74LS155A.PDF`
  - URL (SN74LS155AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls155a.pdf
