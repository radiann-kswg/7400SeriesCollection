# 74x143 — Decade counter/latch/decoder/7-segment driver, constant-current outputs
...
- **機能（EN）**: Decade counter/latch/decoder/7-segment driver, constant-current outputs
- **機能（JP）**: 10進カウンタ/ラッチ/デコーダ/7セグドライバ（定電流）
- **レア度**: `Rare`
