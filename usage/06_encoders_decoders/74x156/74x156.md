# 74x156 — BCD to decimal decoder with open-collector outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: （なし）
  - TTL系: `SN74156N`, `SN74LS156N`, `SN74ALS156N`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS155A,SN74LS156.PDF`
  - URL (SN74ALS156N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74als156.pdf
  - URL (SN74LS156N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls156.pdf
