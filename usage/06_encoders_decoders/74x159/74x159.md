# 74x159 — 4-to-16 line decoder/demultiplexer, open-collector outputs
...
- **機能（EN）**: 4-to-16 line decoder/demultiplexer, open-collector outputs
- **機能（JP）**: 4入力16出力デコーダ/デマルチプレクサ（オープンコレクタ）
- **レア度**: `Maniac(SR+)`
