# 74x136 — Quad 2-input XOR gate with open-collector outputs
...
- [x] **対象の実型番を決める**（入手履歴より自動確認 2026-05-30）
  - CMOS系: （なし）
  - TTL系: `SN74LS136N`, `HD74LS136P`
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS136.PDF`
  - URL (SN74LS136N (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls136.pdf
