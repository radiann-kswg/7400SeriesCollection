# 74x283 — 4-bit binary full adder
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC283.PDF`
  - URL (CD74HC283E (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/cd74hc283.pdf
...
- [x] **電気特性**（VIH/VIL, VOH/VOL, IOL/IOH, tpd など）（データシートより自動確認 2026-05-30, 読み取り信頼度 100%）
  - 参照: `datasheets/_download/TI(TexasInstruments)/CD74HC/CD74HC283.PDF`（一次資料）
