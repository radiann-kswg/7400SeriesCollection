# 74x381 — 4-bit arithmetic logic unit(ALU), generate and propagate outputs
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74LS/SN74LS381A.PDF`
  - URL (SN74LS381AN (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn74ls381.pdf
