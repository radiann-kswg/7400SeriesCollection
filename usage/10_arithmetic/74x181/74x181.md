# 74x181 — 4-bit arithmetic logic unit (ALU)
...
- [x] **データシート参照先**（自動確認 2026-05-30）
  - PDF: `datasheets/_download/TI(TexasInstruments)/SN74S181.PDF`
  - URL (SN74S181NC (TI(TexasInstruments))): https://www.ti.com/lit/ds/symlink/sn54s181.pdf
